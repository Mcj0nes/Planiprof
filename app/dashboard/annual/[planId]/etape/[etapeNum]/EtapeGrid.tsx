...
export default function EtapeGrid({ planId, etapeNumber, startDate, endDate, contentItems, etapeAssignments, weekNotes, planContentActivities = [], calendarEvents = [], planLabel = '' }: Props) {
