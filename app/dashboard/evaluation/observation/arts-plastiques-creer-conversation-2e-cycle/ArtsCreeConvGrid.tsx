...
const CRITERIA = [
  ...
  { key: 'evaluation',    label: 'Réagir à son œuvre' },
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: "couleurs, formes, textures utilisées",
    levels: {
      4: "Décrit son œuvre en nommant plusieurs éléments plastiques (couleurs, formes, textures).",
      3: "Décrit son œuvre en mentionnant quelques éléments.",
      2: "Décrit son œuvre simplement (ex. « j'ai mis du bleu et des cercles »).",
  ...
  },
  {
    ...
    sub: "pourquoi ces couleurs, ces formes, cette technique",
    levels: {
      4: "Explique plusieurs choix et les relie à ce qu'il/elle voulait créer.",
      3: "Explique un ou deux choix avec une justification simple.",
      2: "Mentionne des choix sans les expliquer.",
      1: "Incapable d'expliquer ses choix.",
    },
  },
  {
    key: 'intention',
    label: "Exprimer l'intention",
    sub: "ce que l'œuvre représente ou veut exprimer",
    levels: {
      4: "Exprime clairement ce que l'œuvre veut dire et fait le lien avec des choix visuels.",
      3: "Exprime une intention simple avec un lien à l'œuvre.",
      2: "Exprime une intention vague.",
      1: "Intention absente ou hors sujet.",
    },
  },
  {
    key: 'evaluation',
    label: "Réagir à son œuvre",
    sub: "ce qui est réussi, ce qu'on voudrait changer",
    levels: {
      4: "Identifie clairement ce qui fonctionne et propose des modifications précises.",
      3: "Identifie un élément réussi et un à modifier.",
      2: "Réaction globale simple (ex. « j'aime » ou « je changerais ça »).",
      1: "Incapable de réagir à son œuvre.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Vocabulaire des arts plastiques (2e cycle)",
    sub: "couleurs primaires/secondaires, formes géométriques, texture, ligne",
    levels: {
      4: "Utilise plusieurs mots artistiques appropriés au 2e cycle.",
      3: "Utilise quelques mots artistiques adéquats.",
      2: "Utilise quelques mots simples mais justes.",
      1: "Vocabulaire artistique absent.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses idées",
    sub: "donner une raison liée à son œuvre",
    levels: {
      4: "Justifie ses idées avec plusieurs raisons liées à son œuvre.",
      3: "Donne une justification pertinente.",
      2: "Justification simple ou peu développée.",
      1: "Aucune justification.",
    },
  },
]
