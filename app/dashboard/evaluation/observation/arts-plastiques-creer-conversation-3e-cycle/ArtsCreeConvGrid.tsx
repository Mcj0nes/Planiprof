...
const CRITERIA = [
  { key: 'description',   label: 'Décrire son œuvre' },
  { key: 'choix',         label: 'Choix artistiques' },
  { key: 'intention',     label: 'Intention expressive' },
  { key: 'evaluation',    label: 'Évaluer son œuvre' },
...
export default function ArtsCreeConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Créer, conversation orale</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: "Décrire son œuvre (oral)",
    sub: "couleurs, formes, textures, lignes, espace, composition",
    levels: {
      4: "Décrit son œuvre avec précision, en nommant plusieurs éléments plastiques (couleurs, formes, textures, composition).",
      3: "Décrit son œuvre en mentionnant quelques éléments plastiques pertinents.",
      2: "Décrit son œuvre simplement (ex. « j'ai mis du rouge et des formes rondes »).",
      1: "Description vague, erronée ou absente.",
    },
  },
  {
    key: 'choix',
    label: "Expliquer ses choix artistiques",
    sub: "pourquoi ces couleurs, ces formes, cette composition, cette technique",
    levels: {
      4: "Explique clairement plusieurs choix artistiques en les reliant à son intention.",
  ...
  },
  {
    ...
    sub: "émotion, message, ambiance visuelle voulue",
    levels: {
      4: "Exprime clairement l'intention et la relie à des choix plastiques précis.",
      3: "Exprime une intention générale avec quelques liens à l'œuvre.",
      2: "Exprime une intention vague ou sans lien avec l'œuvre.",
      1: "Intention absente ou hors sujet.",
    },
  },
  {
    key: 'evaluation',
    label: "Évaluer son œuvre",
    sub: "points forts, pistes d'amélioration, regard critique",
    levels: {
      4: "Identifie des points forts et des pistes d'amélioration précises, avec des références visuelles.",
  ...
  {
    key: 'vocabulaire',
    label: "Vocabulaire des arts plastiques (oral)",
    sub: "complémentaires, valeur, perspective, composition, texture, contraste",
    levels: {
      4: "Utilise spontanément un vocabulaire artistique précis et varié pour décrire et analyser son œuvre.",
      3: "Utilise plusieurs mots artistiques adéquats.",
      2: "Utilise un vocabulaire simple mais juste.",
      1: "Vocabulaire artistique absent ou incorrect.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses idées oralement",
    sub: "appuyer ses propos avec des éléments visuels de son œuvre",
    levels: {
      4: "Justifie clairement ses propos en nommant plusieurs éléments visuels de son œuvre; raisonnement oral structuré.",
      3: "Donne une ou deux justifications pertinentes.",
      2: "Justification simple ou minimale.",
      1: "Aucune justification ou justification non liée à l'œuvre.",
    },
  },
]
