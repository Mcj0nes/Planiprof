...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: "Décrire les éléments musicaux (oral)",
    sub: "tempo, intensité, timbre, nuances, structure, instruments, motifs",
    levels: {
      4: "Décrit plusieurs éléments musicaux avec précision; utilise un vocabulaire varié (ex. crescendo, staccato, motif, pulsation).",
      3: "Décrit plusieurs éléments musicaux avec un vocabulaire généralement juste.",
      2: "Décrit un ou deux éléments simples (ex. rapide/lent, fort/doux).",
      1: "Description vague, erronée ou absente.",
    },
  },
  {
    key: 'caractere',
    label: "Identifier et expliquer le caractère ou l'intention de l'œuvre",
    sub: "émotion, ambiance, intention expressive",
    levels: {
      4: "Identifie clairement le caractère et l'explique en s'appuyant sur des éléments musicaux précis (ex. « C'est mystérieux à cause des sons graves et du tempo lent »).",
  ...
  {
    key: 'appreciation',
    label: "Exprimer une appréciation personnelle argumentée (oral)",
    sub: "goût, ressenti, opinion musicale",
    levels: {
      4: "Exprime une appréciation claire et structurée, appuyée sur des éléments musicaux ou expressifs.",
      3: "Exprime une appréciation avec une justification simple.",
      2: "Exprime une appréciation sans justification.",
      1: "Appréciation absente ou hors sujet.",
    },
  },
  {
    key: 'liens',
    label: "Faire des liens pertinents",
    sub: "avec d'autres œuvres, styles, expériences, images mentales",
    levels: {
      4: "Fait des liens pertinents et variés (autres œuvres, styles, expériences, images mentales) et explique ces liens oralement.",
  ...
  {
    key: 'vocabulaire',
    label: "Utiliser un vocabulaire musical précis (oral)",
    sub: "concepts du 3e cycle : nuances, structure, timbre, motifs, pulsation, rythme, texture",
    levels: {
      4: "Utilise spontanément un vocabulaire musical précis et varié pour décrire et analyser l'œuvre.",
  ...
  },
  {
    ...
    sub: "appuyer ses propos avec des éléments entendus",
    levels: {
      4: "Justifie clairement ses propos en nommant plusieurs éléments musicaux entendus; raisonnement oral structuré.",
