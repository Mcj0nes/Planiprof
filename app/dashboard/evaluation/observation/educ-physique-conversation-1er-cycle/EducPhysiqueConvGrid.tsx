...
const CRITERIA = [
  ...
  { key: 'ressenti',     label: 'Ressenti / bien-être' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Éducation physique — Conversation orale — 1er cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: 'Décrire ses actions et mouvements',
    sub: '',
    levels: {
      4: 'Décrit clairement ses actions physiques (ex. : « j\'ai couru vite, puis j\'ai sauté avec les deux pieds »); utilise des mots de mouvement précis.',
      3: 'Décrit ses actions avec quelques hésitations ou imprécisions.',
      2: 'Décrit brièvement ses actions avec des mots très généraux (ex. : « j\'ai bougé », « j\'ai joué »).',
      1: 'Ne parvient pas à décrire ses actions physiques oralement.',
    },
  },
  {
    key: 'regles',
    label: 'Comprendre et expliquer les règles du jeu',
    sub: '',
    levels: {
      4: 'Explique clairement les règles du jeu avec ses mots et donne un exemple concret.',
      3: 'Explique les règles principales avec quelques oublis.',
      2: 'Nomme une ou deux règles sans les expliquer.',
      1: 'Ne parvient pas à nommer ou expliquer les règles.',
    },
  },
  {
    key: 'securite',
    label: 'Sécurité et conscience de l\'espace',
    sub: '',
    levels: {
      4: 'Explique comment bouger en sécurité (ex. : regarder autour, respecter l\'espace des autres); donne des exemples.',
      3: 'Explique une consigne de sécurité avec quelques imprécisions.',
      2: 'Nomme une consigne de sécurité sans l\'expliquer.',
      1: 'Ne parvient pas à nommer de consigne de sécurité.',
    },
  },
  {
    key: 'cooperation',
    label: 'Coopération et interaction verbale',
    sub: '',
    levels: {
      4: 'Explique comment il/elle a collaboré avec ses camarades (ex. : encourager, passer le ballon, attendre son tour) et donne un exemple.',
      3: 'Décrit une forme de coopération avec quelques hésitations.',
      2: 'Mentionne une action coopérative sans la développer.',
      1: 'Ne parvient pas à décrire comment il/elle a coopéré.',
    },
  },
  {
    key: 'ressenti',
    label: 'Exprimer son ressenti et son bien-être',
    sub: '',
    levels: {
      4: 'Exprime clairement comment il/elle s\'est senti(e) pendant l\'activité et explique pourquoi (ex. : « j\'étais fatigué mais content »).',
      3: 'Exprime son ressenti avec quelques hésitations.',
      2: 'Exprime un ressenti simple (ex. : « j\'ai aimé ça ») sans explication.',
      1: 'Ne parvient pas à exprimer son ressenti.',
    },
  },
  {
    key: 'autoeval',
    ...
    sub: '',
    levels: {
      4: 'Identifie ce qui a bien été et ce qu\'il/elle aimerait améliorer, avec un exemple précis.',
      3: 'Identifie un point positif ou à améliorer avec quelques hésitations.',
      2: 'Évalue de façon très générale (ex. : « c\'était bien » / « c\'était dur »).',
      1: 'Ne parvient pas à s\'autoévaluer.',
    },
  },
]
