...
const CRITERIA_FULL = [
  { key: 'intention',    label: 'Idée / Intention',                description: "Exprime une idée simple ou un message personnel dans sa création. Explique ce qu'il veut représenter ou faire ressentir." },
  { key: 'exploration',  label: 'Exploration / Essais',            description: "Essaie différentes façons de faire (couleurs, formes, matériaux). Fait des essais et ajuste avec l'aide de l'enseignant." },
  { key: 'organisation', label: 'Organisation / Composition',      description: "Dispose les éléments visuels de manière équilibrée et réfléchie. Utilise l'espace, les formes et les couleurs avec intention." },
  { key: 'maitrise',     label: 'Maîtrise technique',              description: "Utilise les outils et matériaux correctement et avec soin. Suit les consignes et applique les techniques enseignées." },
  ...
  { key: 'reflexion',    label: 'Réflexion / Retour sur sa démarche', description: "Explique ce qu'il a appris ou ce qu'il referait autrement. Compare son idée de départ et le résultat obtenu." },
]
