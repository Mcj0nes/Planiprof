  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Apprécier — Conversation orale — 2e cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    levels: {
      4: "Décrit l'œuvre de façon détaillée en nommant les éléments visuels (couleurs, formes, lignes, textures, composition).",
      3: 'Décrit plusieurs éléments visuels avec quelques imprécisions.',
      2: 'Décrit seulement les éléments les plus évidents.',
      1: "Ne parvient pas à décrire les éléments visuels de l'œuvre.",
    },
  },
  {
    key: 'analyse',
    label: 'Langage plastique',
    sub: 'Utiliser le langage plastique',
    levels: {
      4: 'Identifie et explique oralement des éléments du langage plastique (ex. : contraste, rythme, espace, matière) en lien avec l\'œuvre.',
      3: 'Nomme quelques éléments du langage plastique avec quelques erreurs.',
      2: 'Utilise des termes généraux sans les mettre en lien avec les éléments plastiques.',
      1: "N'utilise pas le langage plastique dans sa description orale.",
    },
  },
  {
    key: 'reaction',
    label: 'Réaction',
    sub: 'Exprimer sa réaction affective',
    levels: {
      4: "Exprime clairement sa réaction affective et l'explique en faisant référence à des éléments précis de l'œuvre.",
      3: 'Exprime une réaction personnelle pertinente avec quelques hésitations.',
      2: "Exprime une réaction simple sans l'expliquer.",
      1: 'Ne parvient pas à exprimer une réaction personnelle.',
    },
  },
  {
    key: 'contexte',
    label: 'Contexte',
    sub: "Situer l'œuvre dans son contexte",
    levels: {
      4: "Nomme l'artiste, l'époque ou le style et fait un lien avec le sens ou le sujet de l'œuvre.",
      3: 'Mentionne le contexte avec quelques imprécisions.',
      2: "Connaît peu le contexte mais tente d'y faire référence.",
  ...
  },
  {
    key: 'vocabulaire',
    label: 'Vocabulaire',
    sub: 'Utiliser le vocabulaire artistique',
    levels: {
      4: 'Utilise spontanément un vocabulaire artistique précis et varié (ex. : composition, premier plan, palette, matériaux).',
      3: 'Utilise le vocabulaire avec quelques erreurs ou oublis.',
      2: 'Utilise des mots généraux avec peu de vocabulaire artistique.',
  ...
  },
  {
    key: 'jugement',
    label: 'Jugement',
    sub: 'Formuler un jugement appréciatif',
    levels: {
      4: "Formule un jugement appréciatif structuré, avec des arguments fondés sur les éléments de l'œuvre.",
      3: "Formule un jugement pertinent avec quelques lacunes dans l'argumentation.",
      2: "Exprime une préférence sans l'argumenter clairement.",
      1: "Ne formule pas de jugement appréciatif.",
    },
  },
]
