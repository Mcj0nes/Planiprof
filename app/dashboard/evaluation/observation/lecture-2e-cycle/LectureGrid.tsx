...
const CRITERIA = [
  ...
  { key: 'structure',      label: 'Structure du texte' },
  { key: 'reaction',       label: 'Appréciation' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Lecture</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a de la difficulté à saisir le sens global du texte; les inférences et les stratégies lui sont peu accessibles.",
  2: "L'élève comprend les informations explicites avec aide; commence à faire des inférences simples et à identifier la structure.",
  3: "L'élève comprend et interprète les textes de façon autonome; utilise ses stratégies et justifie ses réactions.",
  4: "L'élève dépasse les attentes : inférences fines, analyse de la structure, appréciation nuancée et liens pertinents.",
}

const CRITERIA_FULL = [
  { key: 'comprehension', label: 'Compréhension',        description: "Comprend les informations explicites et implicites d'un texte varié. Peut reformuler l'essentiel et répondre à des questions de compréhension." },
  { key: 'inference',     label: 'Inférence',            description: "Formule des inférences à partir d'indices dans le texte. Déduit des informations qui ne sont pas directement énoncées." },
  { key: 'strategies',    label: 'Stratégies',           description: "Utilise de façon autonome plusieurs stratégies de lecture (déduction, survol, questionnement, résumé) pour résoudre les problèmes de compréhension." },
  { key: 'vocabulaire',   label: 'Vocabulaire',          description: "Comprend le sens de mots dans leur contexte; utilise le contexte ou la structure des mots pour inférer le sens des termes moins connus." },
  { key: 'structure',     label: 'Structure du texte',   description: "Reconnaît les caractéristiques des différents types de textes (narratif, informatif, poétique) et en identifie les éléments organisateurs." },
  { key: 'reaction',      label: 'Appréciation',         description: "Justifie sa réaction à une œuvre ou un texte en s'appuyant sur des éléments précis. Établit des liens avec ses expériences personnelles." },
]
