...
export default async function ArtsApprecier3eCyclePrintAllPage({
  searchParams,
}: {
  ...
  if (!etape) redirect('/dashboard/evaluation/observation/arts-plastiques-apprecier-3e-cycle')
  ...
  return (
    <>
      ...
      <div className="p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Arts plastiques — Apprécier — 3e cycle</h1>
