...
const CRITERIA = [
  ...
  { key: 'inference',      label: 'Inférence / Critique' },
  { key: 'strategies',     label: 'Stratégies' },
  { key: 'structure',      label: 'Structure / Procédés' },
  { key: 'appreciation',   label: 'Appréciation' },
  { key: 'transfert',      label: 'Transfert / Liens' },
] as const
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a de la peine à dépasser le sens littéral; l'interprétation, la critique et les liens restent très limités.",
  2: "L'élève saisit le sens général; commence à formuler des inférences et à analyser la structure avec aide.",
  3: "L'élève lit de façon autonome et critique; interprète, analyse les procédés et apprécie les œuvres avec justesse.",
  4: "L'élève excelle : lecture critique fine, analyse des procédés littéraires, appréciation nuancée et liens enrichissants.",
}

const CRITERIA_FULL = [
  { key: 'comprehension', label: 'Compréhension',          description: "Comprend les informations implicites et les sous-entendus dans des textes variés et complexes. Saisit les nuances de sens." },
  { key: 'inference',     label: 'Inférence / Critique',   description: "Formule des inférences nuancées; distingue faits et opinions. Porte un regard critique sur les intentions de l'auteur." },
  { key: 'strategies',    label: 'Stratégies',             description: "Mobilise un répertoire étendu de stratégies avec autonomie et flexibilité selon les difficultés rencontrées dans le texte." },
  { key: 'structure',     label: 'Structure / Procédés',   description: "Analyse la structure d'un texte et identifie les procédés d'écriture (figures de style, temps verbaux, organisation) et leurs effets." },
  { key: 'appreciation',  label: 'Appréciation',           description: "Apprécie des œuvres littéraires en s'appuyant sur des éléments précis du texte (personnages, thèmes, style, valeurs transmises)." },
  { key: 'transfert',     label: 'Transfert / Liens',      description: "Établit des liens entre les textes lus, ses connaissances du monde et d'autres disciplines; enrichit sa compréhension et sa culture." },
]
