...
const CRITERIA = [
  ...
  { key: 'choix',         label: 'Expliquer un choix' },
  { key: 'intention',     label: 'Ce que ça représente' },
  { key: 'evaluation',    label: 'Aimer / vouloir changer' },
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: "couleurs, formes, matériaux utilisés",
    levels: {
      4: "Décrit son œuvre en nommant plusieurs éléments (couleurs, formes, matériaux).",
      3: "Décrit son œuvre en nommant deux éléments ou plus.",
      2: "Décrit son œuvre avec un seul élément (ex. « j'ai mis du rouge »).",
      1: "Description vague ou absente.",
    },
  },
  {
    key: 'choix',
    label: "Expliquer un choix",
    sub: "pourquoi cette couleur, cette forme, ce matériau",
    levels: {
      4: "Explique plusieurs choix avec une raison claire pour chacun.",
      3: "Explique un choix avec une raison.",
      2: "Mentionne un choix sans raison.",
      1: "Incapable d'expliquer ses choix.",
    },
  },
  {
    key: 'intention',
    label: "Dire ce que ça représente",
    sub: "l'histoire, le sujet, ce que l'image montre",
    levels: {
      4: "Explique clairement ce que son œuvre représente et fait le lien avec des éléments visuels.",
      3: "Explique ce que son œuvre représente simplement.",
      2: "Décrit vaguement ce que ça représente.",
      1: "Ne parvient pas à expliquer ce que ça représente.",
    },
  },
  {
    key: 'evaluation',
    label: "Dire ce qu'on aime / voudrait changer",
    sub: "réaction spontanée à son œuvre",
    levels: {
      4: "Identifie ce qui est réussi et ce qu'il/elle voudrait modifier, avec une raison.",
      3: "Identifie ce qui est réussi OU ce qu'il/elle voudrait modifier.",
      2: "Réaction globale (ex. « j'aime beaucoup ») sans précision.",
      1: "Ne se prononce pas ou répond hors sujet.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Vocabulaire des arts plastiques (1er cycle)",
    sub: "couleurs primaires, formes de base, lignes",
    levels: {
      4: "Utilise plusieurs mots artistiques de base de façon appropriée.",
      3: "Utilise quelques mots artistiques corrects.",
  ...
  {
    key: 'interaction',
    label: "Participer à l'échange",
    sub: "répondre aux questions de l'enseignant·e",
    levels: {
      4: "Participe activement; répond aux questions avec des phrases complètes.",
