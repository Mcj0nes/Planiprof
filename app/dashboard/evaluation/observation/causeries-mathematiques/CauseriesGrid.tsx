  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Causeries mathématiques</h2>
...
const CRITERIA_FULL = [
  { key: 'strategies',    label: 'Stratégies',         description: 'Utilise des stratégies variées et efficaces.' },
  { key: 'raisonnement',  label: 'Raisonnement',        description: 'Explique clairement sa démarche et les étapes de son raisonnement.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',         description: 'Utilise le vocabulaire mathématique approprié.' },
  { key: 'liens',         label: 'Liens',               description: 'Fait des liens entre les concepts.' },
  { key: 'ecoute',        label: 'Écoute',              description: 'Écoute et réagit aux idées des pairs.' },
  { key: 'risques',       label: 'Risque / erreur',     description: "Prend des risques et accepte l'erreur." },
  { key: 'argumentation', label: 'Argumentation',       description: 'Justifie sa réponse avec des arguments mathématiques.' },
]
