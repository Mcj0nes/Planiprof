...
export default async function ObservationPrintAllPage({
  searchParams,
}: {
  ...
  if (!etape) redirect('/dashboard/evaluation/observation/causeries-mathematiques')
  ...
  return (
    <>
      ...
      <div className="p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Causeries mathématiques</h1>
        ...
        {data.grids.map((grid, gi) => (
          <div
            key={gi}
            style={{ pageBreakBefore: gi > 0 ? 'always' : 'auto', marginBottom: 48 }}
          >
