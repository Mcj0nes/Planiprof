  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — 1er cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour accomplir les étapes du processus d'écriture.",
  2: "L'élève réalise les étapes du processus d'écriture avec l'accompagnement de l'enseignant.",
  3: "L'élève réalise les étapes du processus d'écriture de façon autonome.",
  4: "L'élève réalise les étapes du processus d'écriture avec fluidité, créativité et autonomie.",
}

const CRITERIA_FULL = [
  { key: 'planification',  label: 'Planification',          description: "Génère des idées avant d'écrire à l'aide d'un dessin, d'une liste ou d'un schéma." },
  { key: 'organisation',   label: 'Organisation des idées', description: "Structure son texte avec un début, un développement et une fin simples." },
  { key: 'coherence',      label: 'Cohérence textuelle',    description: "Rédige des phrases liées au sujet avec des marqueurs de relation simples (et, parce que, alors)." },
  { key: 'revision',       label: 'Révision',               description: "Relit son texte pour vérifier le sens et la continuité des idées." },
  { key: 'autocorrection', label: 'Autocorrection',         description: "Corrige les erreurs d'orthographe et de ponctuation repérées à l'aide des outils disponibles." },
  { key: 'amelioration',   label: 'Amélioration du texte',  description: "Améliore son texte en tenant compte des commentaires reçus." },
]
