  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Causeries mathématiques — 2e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour s'engager dans la causerie.",
  2: "L'élève progresse avec l'accompagnement de l'enseignant ou des pairs.",
  3: "L'élève maîtrise le critère de façon autonome.",
  4: "L'élève dépasse les attentes et enrichit la discussion.",
}

const CRITERIA_FULL = [
  { key: 'strategies',    label: 'Stratégies',    description: 'Utilise des stratégies variées pour résoudre un problème (schéma, tableau, estimation).' },
  { key: 'raisonnement',  label: 'Raisonnement',  description: 'Explique sa démarche de façon structurée et logique.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',   description: 'Utilise le vocabulaire mathématique approprié au niveau.' },
  { key: 'ecoute',        label: 'Écoute',        description: "Écoute activement et reformule l'idée d'un pair." },
  { key: 'liens',         label: 'Liens',         description: 'Fait des liens entre les concepts mathématiques abordés.' },
  { key: 'risques',       label: 'Risque / erreur', description: "Prend des risques intellectuels et accepte d'ajuster sa démarche." },
  { key: 'argumentation', label: 'Argumentation', description: 'Justifie ses réponses avec des arguments mathématiques clairs.' },
]
