...
const CRITERIA = [
  ...
  { key: 'genre',       label: 'Text Features & Genre' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">English — Writing — Oral Conversation — Cycle 2</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: 'Articulating purpose and intended readership',
    levels: {
      4: 'Clearly explains the purpose and identifies the intended audience, adapting tone or vocabulary accordingly.',
      3: 'States purpose and audience with minor hesitation.',
      2: 'Names the text type without explaining purpose or audience.',
      1: 'Has difficulty articulating why or for whom the text is written.',
    },
  },
  {
    key: 'planning',
    label: 'Planning & Organization',
    sub: 'Describing how the text was planned and structured',
    levels: {
      4: 'Explains the planning process (e.g., brainstorm, outline) and describes the overall structure of the text.',
      3: 'Describes the plan with some gaps.',
      2: 'Mentions having a plan without explaining it.',
      1: 'Has difficulty explaining how the text was planned.',
    },
  },
  {
    key: 'coherence',
    label: 'Coherence & Flow',
    sub: 'Explaining how ideas are linked and flow within the text',
    levels: {
      4: 'Explains how ideas are connected using linking words and how the text flows from one idea to the next.',
      3: 'Describes coherence with some gaps.',
      2: 'Identifies a link between two sentences but cannot explain overall flow.',
      1: 'Has difficulty explaining how ideas are connected.',
    },
  },
  {
    key: 'word_choice',
    label: 'Word Choice',
    sub: 'Reflecting on vocabulary selected for effect',
    levels: {
      4: 'Explains specific word choices and why they were effective for the audience or purpose.',
      3: 'Discusses word choices with some reasoning.',
      2: 'Identifies interesting words without explaining the choice.',
      1: 'Has difficulty discussing word choice.',
    },
  },
  {
    key: 'revision',
    label: 'Revision',
    sub: 'Identifying what was changed or could be improved',
    levels: {
      4: 'Describes specific revisions made and explains what they improved; identifies further potential changes.',
      3: 'Mentions a revision with some explanation.',
      2: 'Says something was changed without explaining what or why.',
      1: 'Has difficulty talking about revision.',
    },
  },
  {
    key: 'genre',
    label: 'Text Features & Genre',
    sub: 'Identifying genre conventions and structural features used',
    levels: {
      4: 'Names the genre and identifies several text features used (e.g., paragraphs, dialogue, headings) and explains why.',
      3: 'Names the genre and one or two features.',
      2: 'Names the genre without identifying features.',
      1: 'Has difficulty identifying the genre or its features.',
    },
  },
]
