...
export default async function AnglaisEcritureConversation2eCyclePage({
  searchParams,
}: {
  ...
  const nav = (
    <nav className="px-6 py-4 flex items-center gap-3 flex-wrap" style={{ backgroundColor: 'var(--color-nav)' }}>
      ...
      <span className="text-white/40">/</span>
      <h1 className="text-sm font-semibold text-white">English — Writing — Conversation — Cycle 2</h1>
    </nav>
  )
  ...
  const header = (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Cycle 2 — Elementary (Grade 3 &amp; 4) — Observation Grid — Mastery Levels
      </p>
      {vue !== 'ensemble' && (
      ...
      <main className="min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-8 py-10">
          ...
          <div className="hidden print:block mb-4">
            <h2 className="text-xl font-bold text-gray-900">English — Writing — Oral Conversation — Cycle 2 — Overview</h2>
