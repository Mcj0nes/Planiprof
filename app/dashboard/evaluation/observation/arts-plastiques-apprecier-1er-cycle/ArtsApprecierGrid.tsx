  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Apprécier — 1er cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour observer et exprimer sa réaction face à une œuvre.",
  2: "L'élève observe et réagit à une œuvre avec l'accompagnement de l'enseignant.",
  3: "L'élève observe, décrit et exprime son appréciation de façon autonome.",
  4: "L'élève formule une appréciation détaillée et personnelle, bien ancrée dans ses observations.",
}

const CRITERIA_FULL = [
  { key: 'observation', label: 'Observation de l\'œuvre',      description: "Observe attentivement une œuvre en prenant le temps de la regarder avec soin." },
  { key: 'description', label: 'Description des éléments',     description: "Nomme et décrit des éléments visuels simples : couleurs, formes, lignes, personnages." },
  { key: 'analyse',     label: 'Langage plastique',            description: "Identifie des éléments du langage plastique vus en classe (ex. : couleurs chaudes/froides, formes géométriques)." },
  { key: 'reaction',    label: 'Réaction personnelle',         description: "Exprime spontanément sa réaction — ce qu'il aime, ce qu'il ressent — face à une œuvre." },
  { key: 'contexte',    label: 'Mise en contexte',             description: "Reconnaît que l'œuvre a été créée par quelqu'un dans un contexte particulier (artiste, lieu, époque)." },
  { key: 'jugement',    label: 'Jugement esthétique',          description: "Exprime un jugement simple et personnel, appuyé par au moins un élément observé." },
]
