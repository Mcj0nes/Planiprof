...
export default function ExposesGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Grille : Oral</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour réaliser un exposé oral.",
  2: "L'élève progresse avec l'accompagnement de l'enseignant ou des pairs.",
  3: "L'élève maîtrise le critère de façon autonome.",
  4: "L'élève dépasse les attentes et enrichit la communication.",
}

const CRITERIA_FULL = [
  { key: 'clarte',        label: 'Clarté',         description: 'Explique ses idées de façon compréhensible et précise.' },
  { key: 'organisation',  label: 'Organisation',    description: 'Structure son discours de manière logique.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',     description: 'Utilise un vocabulaire disciplinaire juste et précis.' },
  { key: 'prononciation', label: 'Prononciation',   description: 'Articule clairement et prononce correctement les termes.' },
  { key: 'fluidite',      label: 'Fluidité',        description: "S'exprime avec aisance et continuité." },
  { key: 'ecoute',        label: 'Écoute',          description: 'Écoute activement et réagit de façon appropriée.' },
  { key: 'pertinence',    label: 'Pertinence',      description: 'Sélectionne des informations en lien direct avec la tâche.' },
]
