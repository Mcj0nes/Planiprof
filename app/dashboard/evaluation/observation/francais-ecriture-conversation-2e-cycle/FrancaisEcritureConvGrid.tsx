...
const CRITERIA = [
  ...
  { key: 'intention',     label: 'Intention / destinataire' },
  { key: 'coherence',     label: 'Cohérence du texte' },
  { key: 'choix',         label: 'Choix linguistiques' },
  { key: 'revision',      label: 'Révision' },
  { key: 'genre',         label: 'Caractéristiques du genre' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — Conversation orale — 2e cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    key: 'planification',
    label: 'Planification',
    sub: 'Décrire sa démarche de planification',
    levels: {
      4: "Explique clairement comment il/elle a planifié son texte (schéma, liste d'idées, plan) et pourquoi il/elle a procédé ainsi.",
      3: 'Décrit sa planification avec quelques hésitations ou manques.',
      2: "Mentionne avoir planifié sans détailler sa démarche.",
      1: "Ne parvient pas à décrire comment il/elle a planifié son texte.",
    },
  },
  {
    key: 'intention',
    label: 'Intention / destinataire',
    sub: "Expliquer son intention d'écriture et son destinataire",
    levels: {
      4: "Explique avec précision son intention (informer, divertir, convaincre) et adapte son texte à un destinataire clairement identifié.",
      3: 'Explique son intention et son destinataire avec quelques imprécisions.',
      2: "Nomme l'intention ou le destinataire sans les relier à son texte.",
      1: "Ne parvient pas à expliquer son intention ou son destinataire.",
    },
  },
  {
    key: 'coherence',
    label: 'Cohérence du texte',
    sub: 'Réfléchir à la cohérence de son texte',
    levels: {
      4: "Explique comment les idées s'enchaînent dans son texte et donne un exemple de lien entre les parties (organisateurs textuels, reprises).",
      3: "Identifie comment ses idées s'enchaînent avec quelques hésitations.",
      2: "Mentionne que ses idées sont en ordre sans l'expliquer.",
      1: "Ne peut pas expliquer comment ses idées sont organisées.",
    },
  },
  {
    key: 'choix',
    label: 'Choix linguistiques',
    sub: 'Justifier ses choix linguistiques',
    levels: {
      4: "Justifie ses choix de vocabulaire, de ponctuation ou de structure de phrases en lien avec son intention ou son destinataire.",
      3: 'Explique quelques choix linguistiques avec des justifications partielles.',
      2: "Nomme des éléments de son texte sans les justifier.",
      1: "Ne peut pas justifier ses choix linguistiques.",
    },
  },
  {
    key: 'revision',
    label: 'Révision',
    sub: 'Décrire ses stratégies de révision',
    levels: {
      4: "Explique comment il/elle révise son texte (ce qu'il/elle cherche, ce qu'il/elle corrige) et nomme un changement concret apporté.",
      3: 'Décrit sa révision avec quelques lacunes.',
      2: "Mentionne avoir relu sans préciser ce qu'il/elle a vérifié.",
      1: "Ne peut pas décrire comment il/elle révise son texte.",
    },
  },
  {
    key: 'genre',
    label: 'Caractéristiques du genre',
    sub: 'Expliquer les caractéristiques du genre produit',
    levels: {
      4: "Nomme et explique plusieurs caractéristiques du genre produit (ex. : « dans un texte informatif, on utilise des sous-titres et des faits »).",
      3: 'Nomme quelques caractéristiques du genre avec quelques imprécisions.',
      2: "Identifie le genre sans pouvoir en expliquer les caractéristiques.",
      1: "Ne peut pas identifier les caractéristiques du genre produit.",
    },
  },
]
