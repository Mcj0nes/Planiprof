...
const CRITERIA_FULL = [
  { key: 'intention',    label: 'Idée / Intention',            description: "Exprime une idée simple ou un sentiment dans sa création. Peut expliquer brièvement ce qu'il voulait faire ou représenter." },
  { key: 'exploration',  label: 'Exploration / Essais',         description: "Essaie différentes façons de faire avec les matériaux proposés. Accepte de tâtonner, de recommencer et d'explorer." },
  { key: 'organisation', label: 'Organisation / Composition',   description: "Dispose les éléments visuels (formes, couleurs, lignes) dans l'espace de façon intentionnelle, même simple." },
  { key: 'maitrise',     label: 'Maîtrise technique',           description: "Utilise les outils et matériaux de base (crayon, pinceau, ciseaux, colle) avec soin et selon les consignes données." },
  { key: 'observation',  label: 'Observation / Référence',      description: "Observe des éléments du réel ou des images pour nourrir sa création. Reproduit ou s'inspire de détails simples." },
  { key: 'reflexion',    label: 'Réflexion / Retour',           description: "Peut nommer ce qu'il aime ou ce qu'il referait dans sa création. Identifie un aspect réussi ou à améliorer." },
]
