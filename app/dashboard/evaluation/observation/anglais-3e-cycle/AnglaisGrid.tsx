...
export default function AnglaisGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Anglais langue seconde</h2>
      ...
      <div className="print:hidden bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Observation criteria</h3>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "The student needs constant support to engage in oral activities in English.",
  2: "The student is progressing with teacher prompting and peer support.",
  3: "The student meets expectations and participates with growing autonomy.",
  4: "The student exceeds expectations; participates with confidence and initiative.",
}

const CRITERIA_FULL = [
  { key: 'participation',  label: 'Participation',  description: "Participates spontaneously and confidently; initiates and sustains interactions independently." },
  { key: 'vocabulary',     label: 'Vocabulary',     description: "Uses varied vocabulary, expressions, and language structures accurately and appropriately." },
  { key: 'comprehension',  label: 'Comprehension',  description: "Demonstrates clear understanding of varied oral messages; responds accurately and with nuance." },
  { key: 'conversation',   label: 'Conversation',   description: "Maintains and develops a conversation; elaborates, asks follow-up questions, and responds with detail." },
  { key: 'strategies',     label: 'Strategies',     description: "Uses a wide variety of strategies flexibly (paraphrasing, circumlocution, clarification requests) to ensure communication." },
  { key: 'adaptation',     label: 'Adaptation',     description: "Adapts language, register, and tone to the context and audience with awareness and appropriateness." },
]
