...
export default async function Anglais3eCyclePage({
  searchParams,
}: {
  ...
  const header = (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Anglais, langue seconde — 3e cycle du primaire (5e et 6e année) — Interacts orally in English — Grille d&apos;observation
      </p>
      {vue !== 'ensemble' && (
