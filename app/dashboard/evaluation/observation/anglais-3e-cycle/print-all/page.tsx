...
export default async function Anglais3eCyclePrintAllPage({
  searchParams,
}: {
  ...
  if (!etape) redirect('/dashboard/evaluation/observation/anglais-3e-cycle')
  ...
  return (
    <>
      ...
      <div className="p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Anglais langue seconde — 3e cycle</h1>
