...
const CRITERIA = [
  { key: 'intention',    label: 'Intention d\'écriture' },
  { key: 'idees',        label: 'Parler de ses idées' },
  { key: 'genre',        label: 'Reconnaître le genre' },
  { key: 'mots',         label: 'Choix de mots' },
  { key: 'phrases',      label: 'Construire ses phrases' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — Conversation orale — 1er cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'intention',
    label: "Comprendre et expliquer son intention d'écriture",
    sub: "",
    levels: {
      4: "Explique clairement pourquoi il/elle écrit ce texte et à qui il est destiné (ex. : « j'écris une histoire pour faire rire mes amis »).",
      3: "Explique son intention avec quelques hésitations.",
      2: "Nomme le type de texte sans expliquer l'intention.",
      1: "Ne parvient pas à expliquer pourquoi il/elle écrit ce texte.",
    },
  },
  {
    key: 'idees',
    label: "Parler de ses idées et de leur origine",
    sub: "",
    levels: {
      4: "Explique d'où viennent ses idées et comment il/elle les a choisies pour son texte (ex. : « j'ai pensé à mon chien », « j'ai regardé une image »).",
      3: "Parle de ses idées avec quelques hésitations.",
      2: "Nomme une idée de son texte sans expliquer d'où elle vient.",
      1: "Ne parvient pas à parler des idées de son texte.",
    },
  },
  {
    key: 'genre',
    label: "Reconnaître les caractéristiques du genre",
    sub: "",
    levels: {
      4: "Identifie le genre de son texte et nomme une ou deux caractéristiques (ex. : « c'est un conte parce qu'il y a un personnage et un problème »).",
      3: "Nomme le genre avec quelques imprécisions.",
      2: "Nomme le genre sans pouvoir expliquer ses caractéristiques.",
      1: "Ne parvient pas à identifier le genre de son texte.",
    },
  },
  {
    key: 'mots',
    label: "Réfléchir à son choix de mots",
    sub: "",
    levels: {
      4: "Explique pourquoi il/elle a choisi certains mots (ex. : « j'ai mis \"immense\" parce que c'était très grand »); démontre une conscience du vocabulaire.",
      3: "Parle de ses choix de mots avec quelques hésitations.",
      2: "Répète les mots de son texte sans expliquer pourquoi il/elle les a choisis.",
      1: "Ne peut pas parler de ses choix de mots.",
    },
  },
  {
    key: 'phrases',
    label: "Réfléchir à la construction de ses phrases",
    sub: "",
    levels: {
      4: "Explique comment il/elle a construit ses phrases (majuscule, point, ordre des mots) et donne un exemple.",
      3: "Parle de ses phrases avec quelques imprécisions.",
      2: "Mentionne une phrase de son texte sans la commenter.",
      1: "Ne peut pas parler de la construction de ses phrases.",
    },
  },
  {
    key: 'amelioration',
    label: "Identifier ce qu'on pourrait améliorer",
    sub: "",
    levels: {
      4: "Identifie spontanément quelque chose à améliorer dans son texte et explique comment il/elle le ferait.",
      3: "Identifie quelque chose à améliorer avec un peu d'aide.",
      2: "Dit que son texte est bien sans identifier d'amélioration possible.",
      1: "Ne parvient pas à identifier une piste d'amélioration.",
    },
  },
]
