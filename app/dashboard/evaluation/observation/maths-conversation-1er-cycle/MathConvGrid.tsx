  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Mathématique — Conversation orale — 1er cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: "",
    levels: {
      4: "Explique la situation avec ses mots, dit ce qu'il doit trouver et nomme les informations importantes.",
      3: "Explique la situation de façon généralement claire.",
      2: "Explique partiellement; oublie des éléments importants.",
      1: "Ne parvient pas à expliquer la situation.",
    },
  },
  {
    key: 'demarche',
    label: "Dire ce qu'il fait (démarche / stratégie)",
    sub: "",
    levels: {
      4: "Explique chaque étape simplement (« Je commence par… », « Après… »).",
      3: "Explique ce qu'il fait avec quelques hésitations.",
      2: "Dit seulement une partie de ce qu'il fait.",
      1: "Ne parvient pas à dire ce qu'il fait.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Utiliser des mots mathématiques",
    sub: "",
    levels: {
      4: "Utilise spontanément des mots mathématiques simples (ex. : plus, moins, groupe, moitié, plus grand).",
      3: "Utilise quelques mots mathématiques.",
      2: "Utilise surtout des mots généraux (« ça », « là », « comme ça »).",
  ...
  },
  {
    ...
    sub: "",
    levels: {
      4: "Explique pourquoi sa réponse a du sens (« Ça marche parce que… »).",
      3: "Donne une justification simple.",
      2: "Donne une réponse sans justification.",
  ...
  },
  {
    ...
    sub: "",
    levels: {
      4: "Écoute les autres, répond en lien avec ce qu'ils disent et reformule parfois.",
