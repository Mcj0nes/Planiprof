...
const CRITERIA = [
  ...
  { key: 'text_type',     label: 'Text Type & Features' },
  { key: 'critical',      label: 'Critical Response' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">English — Reading — Oral Conversation — Cycle 3</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    key: 'comprehension',
    label: 'Comprehension',
    sub: 'Demonstrate deep understanding of the text',
    levels: {
      4: 'Accurately summarizes the text, distinguishing main ideas from supporting details, and demonstrates thorough understanding in complete English sentences.',
      3: 'Demonstrates solid understanding with some gaps or imprecision in the summary.',
      2: 'Understands parts of the text but misses key ideas.',
      1: 'Cannot demonstrate understanding of the text in English.',
    },
  },
  {
    key: 'inference',
    label: 'Inference',
    sub: 'Make and justify inferences',
    levels: {
      4: 'Makes perceptive inferences about unstated information (character motivations, themes, implied meaning) and clearly justifies them with evidence from the text.',
      3: 'Makes a reasonable inference and provides partial justification.',
      2: 'Makes a guess without linking it to the text.',
      1: 'Cannot make an inference about the text.',
    },
  },
  {
    key: 'text_type',
    label: 'Text Type & Features',
    sub: 'Identify text type, purpose, and features',
    levels: {
      4: 'Correctly identifies the text type (narrative, informational, opinion) and explains its purpose and several key features (e.g., "This is an opinion text because it has arguments and a conclusion").',
      3: 'Identifies the text type with some explanation, with minor gaps.',
      2: 'Names the text type without explaining its features.',
      1: 'Cannot identify the text type or its features.',
    },
  },
  {
    key: 'critical',
    label: 'Critical Response',
    sub: 'Respond critically to the text',
    levels: {
      4: "Evaluates the text critically — assesses the author's choices, the reliability of information, or the text's effectiveness — with arguments supported by the text.",
      3: 'Expresses a critical response with some reasoning but limited depth.',
      2: 'Expresses a preference without critical reasoning.',
      1: 'Cannot respond critically to the text.',
    },
  },
  {
    key: 'vocabulary',
    label: 'Vocabulary',
    sub: 'Use and explain vocabulary in context',
    levels: {
      4: 'Uses sophisticated vocabulary from the text accurately and explains the meaning of challenging words using context clues, examples, or synonyms.',
      3: 'Uses vocabulary from the text with occasional errors; explains meaning with some support.',
      2: 'Recognizes vocabulary but struggles to explain meaning.',
      1: 'Does not use or explain vocabulary from the text.',
    },
  },
  {
    key: 'connection',
    label: 'Connections',
    sub: 'Make meaningful connections',
    levels: {
      4: 'Makes meaningful text-to-self, text-to-text, or text-to-world connections and articulates them clearly in English with explanation of relevance.',
      3: 'Makes a connection and explains it with some hesitation.',
      2: 'States a connection without explaining its relevance.',
      1: 'Cannot make or express a connection to the text.',
    },
  },
]
