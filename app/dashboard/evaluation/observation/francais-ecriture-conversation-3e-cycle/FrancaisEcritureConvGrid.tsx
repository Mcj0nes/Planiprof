...
const CRITERIA = [
  { key: 'demarche',      label: 'Démarche d\'auteur' },
  { key: 'intention',     label: 'Intention / genre / destinataire' },
  { key: 'style',         label: 'Choix stylistiques' },
  { key: 'coherence',     label: 'Cohérence et progression' },
  { key: 'revision',      label: 'Révision critique' },
  { key: 'metacognition', label: 'Réflexion sur soi comme auteur' },
] as const
...
export default function FrancaisEcritureConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — Conversation orale — 3e cycle</h2>
      ...
      <div className="print-table-wrap overflow-x-auto rounded-2xl border border-gray-200 shadow-sm mb-10">
        <table className="border-collapse text-sm" style={{ minWidth: 820 }}>
          <thead>
            <tr>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'demarche',
    label: 'Démarche d\'auteur',
    sub: 'Analyser sa démarche d\'auteur',
    levels: {
      4: 'Décrit de façon précise et réflexive chaque étape de sa démarche (planification, rédaction, révision); explique ses choix à chaque étape.',
      3: 'Décrit sa démarche avec pertinence et quelques lacunes dans la réflexion.',
      2: 'Décrit les étapes de façon générale sans les analyser.',
      1: 'Ne parvient pas à décrire sa démarche d\'auteur.',
    },
  },
  {
    key: 'intention',
    label: 'Intention / genre / destinataire',
    sub: 'Expliquer l\'intention, le genre et le destinataire',
    levels: {
      4: 'Explique son intention d\'écriture avec précision, justifie le choix du genre et adapte son discours à un destinataire clairement défini; établit des liens entre ces trois éléments.',
      3: 'Explique les trois éléments avec quelques imprécisions dans les liens.',
      2: 'Identifie l\'intention et le genre sans les relier au destinataire.',
      1: 'Ne parvient pas à articuler intention, genre et destinataire.',
    },
  },
  {
    key: 'style',
    label: 'Choix stylistiques',
    sub: 'Réfléchir à ses choix stylistiques',
    levels: {
      4: 'Explique et justifie ses choix stylistiques (variation des phrases, vocabulaire précis, procédés d\'écriture) en lien avec l\'effet souhaité sur le lecteur.',
      3: 'Identifie quelques choix stylistiques avec des justifications partielles.',
      2: 'Nomme des éléments de son texte sans les relier à un effet stylistique.',
      1: 'Ne peut pas réfléchir à ses choix stylistiques.',
    },
  },
  {
    key: 'coherence',
    label: 'Cohérence et progression',
    sub: 'Analyser la cohérence et la progression du texte',
    levels: {
      4: 'Explique comment les idées progressent dans son texte; justifie ses choix d\'organisateurs, de reprises et de transitions pour assurer la cohérence.',
      3: 'Explique la cohérence de son texte avec quelques lacunes.',
      2: 'Affirme que son texte est cohérent sans l\'expliquer.',
      1: 'Ne peut pas analyser la cohérence ou la progression de son texte.',
    },
  },
  {
    key: 'revision',
    label: 'Révision critique',
    sub: 'Mener une révision critique',
    levels: {
      4: 'Explique de façon critique ce qu\'il/elle a révisé, pourquoi, et comment il/elle a amélioré son texte; mentionne des décisions difficiles.',
      3: 'Décrit sa révision avec pertinence et quelques hésitations.',
      2: 'Mentionne avoir relu et corrigé sans préciser ses critères.',
      1: 'Ne peut pas décrire sa démarche de révision.',
    },
  },
  {
    key: 'metacognition',
    label: 'Réflexion sur soi comme auteur',
    sub: 'Réflexion sur soi comme auteur',
    levels: {
      4: 'Réfléchit de façon nuancée sur ses forces, ses défis et son évolution comme auteur; identifie ce qu\'il/elle veut améliorer avec des objectifs précis.',
      3: 'Réfléchit sur ses forces et défis avec quelques hésitations.',
      2: 'Évalue son travail de façon générale (bien / difficile) sans réflexion sur sa pratique d\'auteur.',
      1: 'Ne peut pas réfléchir sur lui-même / elle-même comme auteur.',
    },
  },
]
