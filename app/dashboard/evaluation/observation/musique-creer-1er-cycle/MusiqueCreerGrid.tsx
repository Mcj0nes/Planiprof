  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Créer — 1er cycle</h2>
...
const CRITERIA_FULL = [
  { key: 'exploration',  label: 'Exploration sonore',   description: 'Explore librement les possibilités sonores (voix, corps, instruments simples).' },
  { key: 'intention',    label: 'Intention créatrice',  description: 'Exprime une idée ou une émotion simple à travers sa création.' },
  { key: 'organisation', label: 'Organisation',         description: 'Donne une forme simple à sa pièce (début, développement, fin).' },
  { key: 'elements',     label: 'Éléments musicaux',    description: 'Utilise au moins un élément musical (rythme, hauteur, timbre, intensité).' },
  { key: 'originalite',  label: 'Originalité',          description: 'Propose des idées personnelles plutôt que de simplement imiter.' },
  { key: 'partage',      label: 'Partage',              description: 'Présente sa création avec confiance devant les pairs.' },
]
