...
const CRITERIA = [
  ...
  { key: 'justesse',     label: 'Justesse mélodique' },
  { key: 'technique',    label: 'Technique' },
  { key: 'nuances',      label: 'Nuances / Phrasé' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Interpréter — 2e cycle</h2>
      ...
      <div className="print-table-wrap overflow-x-auto rounded-2xl border border-gray-200 shadow-sm mb-10">
        <table className="border-collapse text-sm" style={{ minWidth: 720 }}>
          <thead>
            <tr>
...
const CRITERIA_FULL = [
  { key: 'rythme',       label: 'Rythme',              description: 'Respecte avec précision les valeurs rythmiques et maintient la pulsation.' },
  { key: 'justesse',     label: 'Justesse mélodique',  description: 'Chante ou joue les sons à la bonne hauteur de façon soutenue.' },
  { key: 'technique',    label: 'Technique',           description: 'Utilise une technique vocale ou instrumentale appropriée au niveau.' },
  { key: 'nuances',      label: 'Nuances / Phrasé',    description: 'Respecte les indications de nuances et structure le phrasé musical.' },
  { key: 'expression',   label: 'Expression',          description: 'Transmet une intention musicale dans son interprétation.' },
  { key: 'memorisation', label: 'Mémorisation',        description: 'Interprète la pièce de mémoire avec assurance et fluidité.' },
]
