...
const CRITERIA = [
  { key: 'engagement',    label: 'Engagement citoyen' },
  { key: 'reflexion',     label: 'Réflexion critique' },
  { key: 'perspective',   label: 'Perspectives' },
  { key: 'ecoute',        label: 'Écoute' },
  { key: 'dialogue',      label: 'Dialogue éthique' },
...
export default function CCQConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">CCQ — Conversation orale — 3e cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: '',
    levels: {
      4: "S'engage activement dans la discussion sur une question citoyenne; contribue avec des idées personnelles, nuancées et ancrées dans la réalité.",
      3: 'Participe activement avec des contributions pertinentes et quelques hésitations.',
      2: 'Participe peu; répond si sollicité sans approfondir.',
      1: "Ne participe pas ou ne s'engage pas dans le sujet.",
    },
  },
  {
    key: 'reflexion',
    label: 'Réflexion critique',
    sub: '',
    levels: {
      4: 'Analyse la question de façon critique, questionne les présupposés et distingue faits et opinions.',
      3: 'Formule une réflexion critique pertinente avec quelques imprécisions.',
      2: "Exprime une opinion sans la soumettre à un questionnement critique.",
      1: 'Ne démontre pas de réflexion critique sur la question.',
    },
  },
  {
    key: 'perspective',
    label: 'Diversité des perspectives',
    sub: '',
    levels: {
      4: 'Intègre et compare plusieurs perspectives (culturelles, sociales, historiques) dans sa réflexion orale.',
      3: 'Reconnaît plusieurs perspectives avec quelques difficultés à les nuancer.',
      2: "Mentionne d'autres perspectives sans les analyser.",
      1: "N'intègre pas d'autres perspectives dans sa réflexion.",
    },
  },
  {
    key: 'ecoute',
    label: 'Écoute et ouverture',
    sub: '',
    levels: {
      4: 'Écoute attentivement, reformule les propos des autres et ajuste sa position en fonction des échanges.',
      3: 'Écoute bien et réagit de façon appropriée.',
      2: 'Écoute de façon inégale; réactions parfois hors contexte.',
      1: "N'écoute pas ou interrompt régulièrement.",
    },
  },
  {
    key: 'dialogue',
    label: 'Dialogue éthique',
    sub: '',
    levels: {
      4: 'Contribue à un dialogue respectueux et constructif; pose des questions qui relancent la réflexion collective.',
      3: 'Participe au dialogue de façon constructive avec quelques imprécisions.',
      2: "Dialogue sans toujours respecter le fil éthique de la discussion.",
      1: "Ne contribue pas de façon éthique et constructive au dialogue.",
    },
  },
  {
    key: 'argumentation',
    label: 'Argumentation et nuance',
    sub: '',
    levels: {
      4: "Argumente de façon claire, nuancée et fondée sur des valeurs citoyennes; anticipe les contre-arguments.",
      3: 'Argumente avec pertinence avec quelques manques de nuance.',
      2: "Exprime une opinion sans l'argumenter de façon structurée.",
      1: "Ne justifie pas son point de vue ou utilise des arguments non pertinents.",
    },
  },
]
