...
const CRITERIA_FULL = [
  { key: 'clarte',        label: 'Clarté',         description: 'Message compréhensible et idées exprimées simplement.' },
  { key: 'organisation',  label: 'Organisation',    description: 'Idées présentées dans un ordre logique.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',     description: 'Utilisation de mots simples mais appropriés au sujet.' },
  { key: 'prononciation', label: 'Prononciation',   description: 'Articulation claire et mots courants bien prononcés.' },
  { key: 'fluidite',      label: 'Fluidité',        description: "Discours continu avec peu d'hésitations." },
  { key: 'ecoute',        label: 'Écoute',          description: 'Respect des tours de parole et réactions appropriées.' },
  { key: 'pertinence',    label: 'Pertinence',      description: 'Propos en lien direct avec le sujet.' },
]
