...
const CRITERIA = [
  { key: 'temps',         label: 'Société / temps' },
  { key: 'espace',        label: 'Société / espace' },
  { key: 'social',        label: 'Réalités sociales' },
...
export default function USConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Univers social — Conversation orale</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'temps',
    label: "Lire l'organisation d'une société dans le temps (oral)",
    sub: "repères, changements, continuités, causes/conséquences",
    levels: {
      4: "Situe précisément l'époque avec des repères variés; explique clairement un changement ou une continuité et en précise la cause ou la conséquence dans un discours structuré.",
      3: "Situe l'époque avec précision; explique un changement ou une continuité avec quelques hésitations.",
      2: "Situe l'époque de façon générale; explication orale simple ou partielle.",
      1: "Repères temporels confus; explication difficile à suivre ou hors sujet.",
    },
  },
  {
    key: 'espace',
    label: "Lire l'organisation d'une société dans l'espace (oral)",
    sub: "territoire, localisation, caractéristiques, liens territoire–activités humaines",
    levels: {
      4: "Décrit oralement le territoire avec précision; localise correctement; explique un lien significatif entre le territoire et les activités humaines avec un raisonnement clair.",
      3: "Décrit et localise adéquatement; lien territoire‑activité présent mais incomplet.",
      2: "Décrit un élément du territoire; localisation approximative; lien simple.",
      1: "Description orale vague, imprécise ou erronée.",
    },
  },
  {
    key: 'social',
    label: "Lire l'organisation d'une société à partir de ses réalités sociales (oral)",
    sub: "organisation sociale, activités économiques, rôles, mode de vie",
    levels: {
      4: "Explique clairement plusieurs réalités sociales et établit des liens pertinents entre elles (ex. rôle → activité → conséquence).",
      3: "Explique une ou deux réalités sociales avec quelques imprécisions.",
      2: "Mentionne une réalité sociale simple sans approfondir.",
      1: "Explications orales vagues, peu pertinentes ou absentes.",
    },
  },
  {
    key: 'documents',
    label: "Interpréter des documents (oral)",
    sub: "décrire, comprendre, déduire, relier",
    levels: {
      4: "Interprète un ou plusieurs documents en expliquant ce qu'ils montrent et ce que cela signifie; établit un lien entre deux sources si demandé.",
      3: "Interprète un document avec quelques imprécisions; discours généralement clair.",
      2: "Interprétation simple mais juste; discours minimal.",
      1: "Ne parvient pas à décrire ou interpréter oralement.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Utiliser un vocabulaire disciplinaire précis (oral)",
    sub: "continuité, changement, hiérarchie sociale, activité économique, territoire, ressource…",
    levels: {
      4: "Utilise spontanément un vocabulaire disciplinaire précis et varié pour expliquer sa pensée.",
      3: "Utilise plusieurs mots disciplinaires adéquats.",
      2: "Utilise un vocabulaire simple mais juste.",
      1: "Vocabulaire oral limité, imprécis ou absent.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses réponses oralement",
    sub: "preuves, faits, éléments de documents, raisonnement",
    levels: {
      4: "Justifie clairement ses réponses en citant plusieurs faits, exemples ou éléments de documents; raisonnement structuré.",
      3: "Donne une ou deux justifications pertinentes.",
      2: "Justification simple ou minimale.",
      1: "Aucune justification ou justification non liée aux documents.",
    },
  },
]
