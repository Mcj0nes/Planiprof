...
export default function MathConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Mathématique — Conversation orale — 2e cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'comprehension',
    label: "Comprendre et expliquer la situation mathématique",
    sub: "",
    levels: {
      4: "Reformule la situation avec ses mots, identifie les données importantes et explique ce qu'il doit trouver.",
      3: "Explique la situation de façon généralement claire, avec quelques imprécisions.",
      2: "Reformule partiellement; oublie des éléments importants.",
      1: "Ne parvient pas à expliquer la situation ou se trompe de sens.",
    },
  },
  {
    key: 'demarche',
    label: "Décrire sa démarche ou sa stratégie",
    sub: "",
    levels: {
      4: "Explique chaque étape de sa démarche et pourquoi il la choisit.",
      3: "Décrit sa démarche avec quelques oublis ou hésitations.",
      2: "Mentionne une stratégie sans la détailler.",
      1: "Ne parvient pas à expliquer ce qu'il fait.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Utiliser le vocabulaire mathématique",
    sub: "",
    levels: {
      4: "Utilise spontanément des mots mathématiques précis (ex. : additionner, moitié, angle, régulier).",
      3: "Utilise le vocabulaire avec quelques erreurs ou oublis.",
      2: "Utilise des mots généraux (ex. : « ça », « le truc », « la ligne »).",
      1: "N'utilise pas de vocabulaire mathématique.",
    },
  },
  {
    key: 'justification',
    label: "Justifier sa réponse",
    sub: "",
    levels: {
      4: "Explique clairement pourquoi sa réponse est logique; fait des liens simples entre les concepts.",
      3: "Donne une justification partielle ou intuitive.",
      2: "Donne une réponse sans justification claire.",
      1: "Ne justifie pas sa réponse.",
    },
  },
  {
    key: 'interaction',
    label: "Interaction orale en contexte mathématique",
    sub: "",
    levels: {
      4: "Écoute les autres, reformule leurs idées et répond de façon pertinente.",
      3: "Écoute et répond adéquatement.",
      2: "Réagit brièvement ou hors contexte.",
      1: "Interrompt ou ne répond pas en lien avec la discussion.",
    },
  },
]
