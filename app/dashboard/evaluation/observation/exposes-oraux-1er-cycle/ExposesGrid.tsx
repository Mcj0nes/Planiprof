...
const CRITERIA_FULL = [
  { key: 'clarte',        label: 'Clarté',        description: 'Message compréhensible et idées simples.' },
  { key: 'organisation',  label: 'Organisation',   description: 'Idées présentées dans un ordre logique.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',    description: 'Mots simples mais appropriés au sujet.' },
  { key: 'prononciation', label: 'Prononciation',  description: 'Articulation claire et mots courants bien prononcés.' },
  { key: 'fluidite',      label: 'Fluidité',       description: 'Discours simple et continu.' },
  { key: 'ecoute',        label: 'Écoute',         description: 'Respect des tours de parole et réactions simples.' },
