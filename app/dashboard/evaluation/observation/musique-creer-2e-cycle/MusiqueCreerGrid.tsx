  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Créer — 2e cycle</h2>
...
const CRITERIA_FULL = [
  { key: 'exploration',  label: 'Exploration sonore',   description: 'Explore des sons, rythmes et mélodies variés pour enrichir sa création.' },
  { key: 'intention',    label: 'Intention créatrice',  description: 'Définit et exprime une intention artistique dans sa pièce.' },
  { key: 'organisation', label: 'Organisation',         description: 'Construit une structure musicale cohérente et reconnaissable.' },
  { key: 'elements',     label: 'Éléments musicaux',    description: 'Utilise plusieurs éléments musicaux de façon intentionnelle (rythme, mélodie, timbre, nuances).' },
  { key: 'originalite',  label: 'Originalité',          description: 'Fait des choix distinctifs qui révèlent sa personnalité créatrice.' },
  { key: 'revision',     label: 'Révision critique',    description: 'Écoute sa création et apporte des ajustements suite à une réflexion critique.' },
]
