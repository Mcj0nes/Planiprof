...
const CRITERIA = [
  { key: 'ecoute',       label: 'Écoute active' },
  { key: 'description',  label: 'Description des éléments' },
  { key: 'reaction',     label: 'Réaction nuancée' },
  { key: 'vocabulaire',  label: 'Vocabulaire musical' },
  { key: 'comparaison',  label: 'Comparaison d\'œuvres' },
  { key: 'jugement',     label: 'Jugement étayé' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Apprécier — 2e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour apprécier et parler d'une œuvre musicale.",
  2: "L'élève apprécie la musique avec l'accompagnement de l'enseignant.",
  3: "L'élève apprécie et commente la musique de façon autonome en utilisant un vocabulaire approprié.",
  4: "L'élève dépasse les attentes en formulant des appréciations nuancées et bien justifiées.",
}

const CRITERIA_FULL = [
  { key: 'ecoute',      label: 'Écoute active',              description: 'Écoute attentivement et maintient son attention tout au long de l\'œuvre.' },
  { key: 'description', label: 'Description des éléments',   description: 'Identifie plusieurs éléments musicaux (rythme, mélodie, nuances, structure).' },
  { key: 'reaction',    label: 'Réaction nuancée',           description: 'Exprime une réaction personnelle avec un vocabulaire de plus en plus précis.' },
  { key: 'vocabulaire', label: 'Vocabulaire musical',        description: 'Utilise les termes du programme pour décrire et analyser la musique entendue.' },
  { key: 'comparaison', label: 'Comparaison d\'œuvres',      description: 'Identifie des ressemblances et des différences entre deux œuvres musicales.' },
  { key: 'jugement',    label: 'Jugement étayé',             description: 'Formule un jugement d\'appréciation et l\'appuie par des observations musicales.' },
]
