...
export default function CCQGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Culture et citoyenneté québécoise</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève s'implique peu; réflexion superficielle; difficultés à prendre part au dialogue de façon constructive.",
  2: "L'élève participe avec soutien; réflexion en développement; commence à construire des arguments simples.",
  3: "L'élève s'engage de façon autonome; réflexion critique présente; dialogue structuré et respectueux.",
  4: "L'élève dépasse les attentes : pensée critique approfondie, argumentation nuancée, leadership dans les échanges.",
}

const CRITERIA_FULL = [
  { key: 'engagement',    label: 'Engagement citoyen',   description: "Fait preuve d'un engagement citoyen face aux enjeux éthiques et culturels; prend des initiatives dans les activités." },
  { key: 'reflexion',     label: 'Réflexion critique',   description: "Analyse des situations complexes de façon nuancée; identifie des tensions éthiques et propose des pistes de réflexion." },
  { key: 'perspective',   label: 'Perspectives',          description: "Explore activement de multiples perspectives; démontre une ouverture réelle à la différence et à la complexité sociale." },
  { key: 'ecoute',        label: 'Écoute',                description: "Écoute avec ouverture et reformule fidèlement les propos des autres; valide sa compréhension avant de réagir." },
  { key: 'dialogue',      label: 'Dialogue',              description: "Contribue à approfondir les échanges en posant des questions, en nuançant les propos et en maintenant un dialogue constructif." },
  { key: 'argumentation', label: 'Argumentation',         description: "Formule des arguments cohérents et nuancés; reconnaît la complexité des enjeux et ajuste ses positions en fonction des échanges." },
]
