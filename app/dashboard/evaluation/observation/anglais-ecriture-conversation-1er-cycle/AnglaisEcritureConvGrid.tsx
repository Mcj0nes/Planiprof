...
const CRITERIA = [
  { key: 'intention',  label: 'Writing Intention' },
  { key: 'ideas',      label: 'Ideas & Planning' },
  { key: 'words',      label: 'Word Choices' },
  { key: 'sentences',  label: 'Sentence Building' },
  { key: 'revision',   label: 'What to Improve' },
  { key: 'genre',      label: 'Text Type' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">English — Writing — Oral Conversation — Cycle 1</h2>
...
const CRITERIA_FULL: {
  ...
  },
  {
    ...
    sub: 'Talking about ideas and where they come from',
    levels: {
      4: 'Explains where their ideas came from and how they chose them (e.g., "I thought about my dog", "I looked at a picture").',
      3: 'Talks about their ideas with some hesitation.',
      2: 'Names one idea from their text without explaining its origin.',
      1: 'Has difficulty talking about the ideas in their text.',
    },
  },
  {
    key: 'words',
  ...
  },
  {
    ...
    sub: 'Reflecting on how sentences are constructed',
    levels: {
      4: 'Explains how sentences are built (capital letter, period, word order) and gives an example.',
      3: 'Talks about sentences with some inaccuracies.',
      2: 'Mentions a sentence from the text without commenting on it.',
      1: 'Cannot talk about sentence construction.',
    },
  },
  {
    key: 'revision',
    label: 'What to Improve',
    sub: 'Identifying something to change or improve in the text',
    levels: {
      4: 'Spontaneously identifies something to improve and explains how they would change it.',
      3: 'Identifies something to improve with a little prompting.',
      2: 'Says the text is fine without identifying any improvement.',
      1: 'Has difficulty identifying any improvement.',
    },
  },
  {
    key: 'genre',
    label: 'Text Type',
    sub: 'Recognising the type of text and its basic features',
    levels: {
      4: 'Names the text type and identifies one or two features (e.g., "It\'s a story because there\'s a character and a problem").',
      3: 'Names the text type with some inaccuracies.',
      2: 'Names the text type without explaining its features.',
      1: 'Has difficulty identifying the text type.',
    },
  },
]
