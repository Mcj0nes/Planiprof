...
const CRITERIA = [
  { key: 'pulsation',   label: 'Pulsation / Rythme' },
  { key: 'justesse',    label: 'Justesse' },
  { key: 'technique',   label: 'Technique / Posture' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Interpréter — 1er cycle</h2>
...
const CRITERIA_FULL = [
  { key: 'pulsation',    label: 'Pulsation / Rythme',  description: 'Maintient une pulsation stable et respecte les valeurs rythmiques de la pièce.' },
  { key: 'justesse',     label: 'Justesse',             description: 'Chante ou joue les sons à la bonne hauteur.' },
  { key: 'technique',    label: 'Technique / Posture',  description: 'Adopte une posture et une tenue de voix ou d\'instrument appropriées.' },
  { key: 'nuances',      label: 'Nuances',              description: 'Distingue et reproduit les variations de force (fort/doux).' },
  { key: 'expression',   label: 'Expression',           description: 'S\'engage dans l\'interprétation avec expressivité et plaisir musical.' },
  { key: 'memorisation', label: 'Mémorisation',         description: 'Connaît la pièce et l\'interprète avec aisance, sans support constant.' },
]
