...
const CRITERIA = [
  ...
  { key: 'intention',  label: 'Intention & Audience' },
  { key: 'style',      label: 'Style & Voice' },
  { key: 'coherence',  label: 'Coherence & Organization' },
  { key: 'revision',   label: 'Revision & Metacognition' },
  { key: 'genre',      label: 'Genre & Craft' },
] as const
...
export default function AnglaisEcritureConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">English — Writing — Oral Conversation — Cycle 3</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: 'Describing and reflecting on the full writing process used',
    levels: {
      4: 'Describes each stage of the writing process (prewriting, drafting, revising, editing) with specific examples and explains the decisions made at each stage.',
      3: 'Describes most stages with some examples.',
      2: 'Names a stage without describing what was done.',
      1: 'Has difficulty describing the writing process.',
    },
  },
  {
    key: 'intention',
    label: 'Intention & Audience',
    sub: 'Articulating purpose, audience, and how the text was adapted for them',
    levels: {
      4: 'Explains purpose and audience clearly and describes specific adaptations made (e.g., vocabulary level, tone, examples chosen) for that audience.',
      3: 'States purpose and audience and mentions one adaptation.',
      2: 'Names purpose or audience without explaining adaptations.',
      1: 'Has difficulty articulating intention or audience.',
    },
  },
  {
    key: 'style',
    label: 'Style & Voice',
    sub: 'Reflecting on personal voice, tone, and stylistic choices',
    levels: {
      4: 'Articulates their personal voice and explains specific stylistic choices (e.g., sentence rhythm, register, figurative language) and their intended effect.',
      3: 'Discusses style and voice with some examples.',
      2: 'Mentions one stylistic choice without explaining the effect.',
      1: 'Has difficulty discussing style or voice.',
    },
  },
  {
    key: 'coherence',
    label: 'Coherence & Organization',
    sub: 'Explaining how the text is structured and how ideas are sequenced',
    levels: {
      4: 'Explains the overall structure and how transitional strategies (e.g., linking words, paragraph organisation) ensure coherence and guide the reader.',
      3: 'Describes structure and names some transitions.',
      2: 'Mentions a structural element without explaining its function.',
      1: 'Has difficulty explaining how the text is organised.',
    },
  },
  {
    key: 'revision',
    label: 'Revision & Metacognition',
    sub: 'Reflecting on changes made and on growth as a writer',
    levels: {
      4: 'Describes specific revisions made, explains why they strengthened the text, and reflects on what they learned about their own writing.',
      3: 'Describes revisions with some explanation and a partial reflection.',
      2: 'Mentions revisions without explaining their impact.',
      1: 'Has difficulty discussing revision or reflecting on the writing.',
    },
  },
  {
    key: 'genre',
    label: 'Genre & Craft',
    sub: 'Analysing genre conventions and conscious craft decisions',
    levels: {
      4: 'Identifies the genre, explains how specific craft techniques (e.g., foreshadowing, argument structure, descriptive language) were used intentionally and to what effect.',
      3: 'Names the genre and describes one or two craft techniques.',
      2: 'Names the genre without analysing craft choices.',
      1: 'Has difficulty discussing genre conventions or craft.',
    },
  },
]
