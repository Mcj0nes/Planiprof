...
export default async function Anglais2eCyclePage({
  searchParams,
}: {
  ...
  const header = (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-500 mt-1">
        Anglais, langue seconde — 2e cycle du primaire (3e et 4e année) — Interacts orally in English — Grille d&apos;observation
      </p>
      {vue !== 'ensemble' && (
