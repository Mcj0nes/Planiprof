...
const CRITERIA_FULL = [
  { key: 'participation',  label: 'Participation',  description: "Actively participates in oral activities; attempts to engage and respond in English." },
  { key: 'vocabulary',     label: 'Vocabulary',     description: "Uses a range of vocabulary and expressions appropriate to the context; expanding repertoire." },
  { key: 'comprehension',  label: 'Comprehension',  description: "Shows understanding of oral messages (instructions, conversations, short texts)." },
  { key: 'conversation',   label: 'Conversation',   description: "Maintains a simple conversation; responds relevantly and keeps exchanges going." },
  { key: 'strategies',     label: 'Strategies',     description: "Uses communication strategies (circumlocution, gestures, asking for clarification) to maintain interaction." },
  { key: 'conventions',    label: 'Conventions',    description: "Respects conventions of spoken interaction: turn-taking, active listening, and polite exchanges." },
]
