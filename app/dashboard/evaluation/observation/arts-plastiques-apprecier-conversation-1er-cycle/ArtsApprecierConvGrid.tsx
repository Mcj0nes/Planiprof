...
const CRITERIA = [
  { key: 'observation',  label: 'Observer' },
  { key: 'description',  label: 'Décrire' },
  { key: 'reaction',     label: 'Réaction' },
  { key: 'vocabulaire',  label: 'Vocabulaire' },
  { key: 'lien',         label: 'Lien personnel' },
  { key: 'partage',      label: 'Partage oral' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Apprécier — Conversation orale — 1er cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'observation',
    label: 'Observer une œuvre d\'art',
    sub: '',
    levels: {
      4: 'Observe attentivement l\'œuvre et nomme spontanément plusieurs éléments visuels (couleurs, formes, lignes, personnages).',
      3: 'Observe l\'œuvre et nomme quelques éléments avec quelques hésitations.',
      2: 'Observe brièvement; ne nomme que un ou deux éléments évidents.',
      1: 'N\'observe pas ou décrit l\'œuvre de façon non pertinente.',
    },
  },
  {
    key: 'description',
    label: 'Décrire ce qu\'on voit',
    sub: '',
    levels: {
      4: 'Décrit l\'œuvre avec des phrases complètes et des détails visuels précis.',
      3: 'Décrit l\'œuvre de façon généralement claire avec quelques imprécisions.',
      2: 'Décrit partiellement ou utilise des mots très généraux (« beau », « coloré »).',
      1: 'Ne parvient pas à décrire l\'œuvre.',
    },
  },
  {
    key: 'reaction',
    ...
    sub: '',
    levels: {
      4: 'Exprime clairement ce qu\'il/elle ressent face à l\'œuvre et explique pourquoi avec ses mots.',
      3: 'Exprime une réaction personnelle pertinente avec quelques hésitations.',
      2: 'Exprime une réaction simple (« j\'aime » / « j\'aime pas ») sans explication.',
      1: 'Ne parvient pas à exprimer une réaction personnelle.',
    },
  },
  {
    key: 'vocabulaire',
    label: 'Utiliser le vocabulaire plastique',
    sub: '',
    levels: {
      4: 'Utilise spontanément des mots liés aux éléments du langage plastique (couleur, forme, ligne, texture).',
      3: 'Utilise quelques mots du vocabulaire plastique avec des approximations.',
      2: 'Utilise des mots généraux sans vocabulaire plastique spécifique.',
      1: 'N\'utilise pas de vocabulaire plastique.',
    },
  },
  {
    key: 'lien',
    ...
    sub: '',
    levels: {
      4: 'Fait un lien clair entre l\'œuvre et une expérience personnelle ou quelque chose qu\'il/elle connaît.',
      3: 'Fait un lien pertinent avec son vécu avec quelques imprécisions.',
      2: 'Tente un lien sans le développer.',
      1: 'Ne fait pas de lien avec son vécu.',
    },
  },
  {
    key: 'partage',
    ...
    sub: '',
    levels: {
      4: 'Partage ses idées avec enthousiasme, écoute les autres et réagit à leurs commentaires.',
      3: 'Partage ses idées et écoute généralement les autres.',
      2: 'Partage peu; répond si sollicité.',
      1: 'Ne participe pas à l\'échange oral.',
    },
  },
]
