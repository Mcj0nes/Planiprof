...
function JugementCell({ etape, studentName, initialScore }: {
  etape:        number
  studentName:  string
...
export default function EtapeOverview({ etape, grids, rows }: Props) {
  ...
  const printAllUrl = `/dashboard/evaluation/observation/causeries-mathematiques-1er-cycle/print-all?etape=${etape}`
