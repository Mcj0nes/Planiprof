...
const CRITERIA = [
  ...
  { key: 'risques',       label: 'Risque / erreur' },
...
export default function CauseriesGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Causeries mathématiques — 1er cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour participer à la causerie.",
  2: "L'élève participe avec l'encouragement de l'enseignant ou des pairs.",
  3: "L'élève s'engage de façon autonome dans la causerie.",
  4: "L'élève dépasse les attentes et contribue de façon originale à la discussion.",
}

const CRITERIA_FULL = [
  { key: 'strategies',    label: 'Stratégies',    description: 'Utilise des stratégies concrètes pour résoudre un problème (manipulation, dessin, comptage).' },
  { key: 'raisonnement',  label: 'Raisonnement',  description: 'Explique sa démarche avec ses propres mots.' },
  { key: 'vocabulaire',   label: 'Vocabulaire',   description: 'Utilise des termes mathématiques simples et appropriés.' },
  { key: 'ecoute',        label: 'Écoute',        description: "Écoute les autres sans déranger et tente de comprendre leurs idées." },
  { key: 'participation', label: 'Participation', description: 'Partage ses idées et ses réponses pendant la causerie.' },
  { key: 'risques',       label: 'Risque / erreur', description: "Ose partager même en étant incertain et accepte l'erreur comme une occasion d'apprendre." },
  { key: 'liens',         label: 'Liens',         description: 'Fait un lien simple entre le problème mathématique et une situation vécue.' },
]
