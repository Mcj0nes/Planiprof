...
const CRITERIA = [
  { key: 'description',   label: 'Décrire sa création' },
  { key: 'choix',         label: 'Choix musicaux' },
  { key: 'intention',     label: 'Intention expressive' },
  { key: 'evaluation',    label: 'Évaluer sa création' },
  { key: 'vocabulaire',   label: 'Vocabulaire musical' },
...
export default function MusicCreeConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Créer, conversation orale</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: "Décrire sa création (oral)",
    sub: "tempo, nuances, structure, rythme, mélodie, timbre",
    levels: {
      4: "Décrit sa création avec précision, en nommant plusieurs éléments musicaux (structure, nuances, rythme, mélodie); utilise un vocabulaire varié.",
      3: "Décrit sa création en mentionnant quelques éléments musicaux pertinents.",
      2: "Décrit sa création de façon simple (ex. rapide, fort/doux).",
      1: "Description vague, erronée ou absente.",
    },
  },
  {
    key: 'choix',
    label: "Expliquer ses choix musicaux",
    sub: "décisions de composition : pourquoi tel rythme, telle mélodie, tels sons",
    levels: {
      4: "Explique clairement plusieurs choix musicaux en les reliant à son intention expressive.",
      3: "Explique un ou deux choix avec une justification simple.",
      2: "Mentionne des choix sans vraiment les expliquer.",
      1: "Incapable d'expliquer ses choix.",
    },
  },
  {
    key: 'intention',
    label: "Exprimer l'intention expressive",
    sub: "émotion, ambiance, message de la pièce",
    levels: {
      4: "Exprime clairement l'intention expressive et la relie à des choix musicaux précis.",
      3: "Exprime une intention générale avec quelques liens à la musique.",
      2: "Exprime une intention vague ou sans lien avec la musique.",
      1: "Intention absente ou hors sujet.",
    },
  },
  {
    key: 'evaluation',
    label: "Évaluer sa création",
    sub: "points forts, pistes d'amélioration",
    levels: {
      4: "Identifie des points forts et des pistes d'amélioration précises, avec des justifications musicales.",
      3: "Identifie au moins un point fort et un point à améliorer.",
      2: "Évalue superficiellement (ex. « c'est bien » ou « j'aime pas »).",
      1: "Incapable d'évaluer ou ne se prononce pas.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Vocabulaire musical précis (oral)",
    sub: "nuances, tempo, structure, motif, pulsation, timbre, rythme",
    levels: {
      4: "Utilise spontanément un vocabulaire musical précis et varié pour décrire et analyser sa création.",
      3: "Utilise plusieurs mots musicaux adéquats.",
      2: "Utilise un vocabulaire simple mais juste.",
      1: "Vocabulaire musical absent ou incorrect.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses idées oralement",
    sub: "appuyer ses propos avec des éléments de sa création",
    levels: {
      4: "Justifie clairement ses propos en nommant plusieurs éléments de sa création; raisonnement oral structuré.",
      3: "Donne une ou deux justifications pertinentes.",
      2: "Justification simple ou minimale.",
      1: "Aucune justification ou justification non liée à la création.",
    },
  },
]
