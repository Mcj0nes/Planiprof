...
export default function EtapeOverview({ etape, grids, rows }: Props) {
  ...
  const printAllUrl = `/dashboard/evaluation/observation/anglais-lecture-conversation-1er-cycle/print-all?etape=${etape}`
            ...
            <thead>
              <tr>
                ...
                <th className="p-3 bg-blue-50 border-b border-r border-gray-200 font-semibold text-blue-700 text-center" style={{ width: 90, borderLeft: '2px solid #c7d2fe' }}>
                  <span className="block text-xs leading-tight">Average of</span>
                  <span className="block text-xs leading-tight">global results</span>
                </th>
