...
export default function SciConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Sciences — Conversation orale</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'comprehension',
    label: "Comprendre et expliquer la situation scientifique (oral)",
    sub: "compréhension du problème, des phénomènes, des conditions",
    levels: {
      4: "Explique clairement la situation scientifique, identifie les éléments importants et reformule oralement avec précision.",
      3: "Explique la situation avec quelques imprécisions; compréhension généralement claire.",
      2: "Compréhension partielle; explication orale simple ou incomplète.",
      1: "Compréhension confuse; explication hors sujet ou absente.",
    },
  },
  {
    key: 'hypothese',
    label: "Formuler des hypothèses ou des prédictions (oral)",
    sub: "habileté centrale de la démarche scientifique",
    levels: {
      4: "Formule oralement une hypothèse claire, logique et appuyée sur des connaissances scientifiques.",
      3: "Formule une hypothèse plausible mais peu développée.",
      2: "Hypothèse simple ou partiellement liée à la situation.",
      1: "Hypothèse absente, illogique ou non liée à la situation.",
    },
  },
  {
    key: 'demarche',
    label: "Décrire et expliquer une démarche ou une procédure (oral)",
    sub: "planifier, organiser, expliquer comment vérifier",
    levels: {
      4: "Décrit oralement une démarche complète, logique et réalisable; explique pourquoi chaque étape est pertinente.",
      3: "Décrit une démarche adéquate mais avec quelques oublis.",
      2: "Décrit une démarche partielle ou imprécise.",
      1: "Ne parvient pas à décrire une démarche ou propose des étapes incohérentes.",
    },
  },
  {
    key: 'interpretation',
    label: "Interpréter des observations ou des résultats (oral)",
    sub: "analyser ce qu'on voit, ce que ça signifie, ce que ça démontre",
    levels: {
      4: "Interprète clairement les observations; explique ce qu'elles signifient et établit un lien logique avec l'hypothèse ou le phénomène.",
      3: "Interprète les observations avec quelques imprécisions; lien partiel avec l'hypothèse.",
      2: "Décrit les observations sans interprétation claire.",
      1: "Interprétation absente ou erronée.",
    },
  },
  {
    key: 'connaissances',
    label: "Mobiliser des connaissances scientifiques (oral)",
    sub: "concepts, phénomènes, propriétés, relations",
    levels: {
      4: "Utilise spontanément un vocabulaire scientifique précis et mobilise des connaissances justes pour expliquer son raisonnement.",
      3: "Utilise plusieurs mots scientifiques adéquats; connaissances généralement justes.",
      2: "Utilise un vocabulaire simple; connaissances partielles.",
      1: "Vocabulaire scientifique absent ou incorrect; connaissances erronées.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses idées oralement",
    sub: "appuyer ses propos avec des faits, observations, connaissances",
    levels: {
      4: "Justifie clairement ses idées en s'appuyant sur plusieurs faits, observations ou connaissances scientifiques; raisonnement structuré.",
      3: "Donne une ou deux justifications pertinentes.",
      2: "Justification simple ou minimale.",
      1: "Aucune justification ou justification non scientifique.",
    },
  },
]
