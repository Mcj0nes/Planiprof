...
const CRITERIA = [
  ...
  { key: 'strategie',   label: 'Stratégies d\'action' },
  { key: 'cooperation', label: 'Leadership / Coop.' },
  { key: 'fairplay',    label: 'Fair-play' },
  { key: 'securite',    label: 'Sécurité autonome' },
  { key: 'sante',       label: 'Habitudes de vie' },
] as const
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un encadrement constant pour appliquer les habiletés et les stratégies enseignées.",
  2: "L'élève progresse avec aide ; commence à utiliser des stratégies simples et à s'engager dans l'équipe.",
  3: "L'élève est autonome : actions motrices efficaces, stratégies pertinentes, leadership et fair-play constants.",
  4: "L'élève excelle : maîtrise technique supérieure, stratégies innovantes, modèle de fair-play et de sécurité.",
}

const CRITERIA_FULL = [
  { key: 'habiletes',   label: 'Habiletés motrices',        description: "Maîtrise les habiletés motrices dans des contextes complexes et variés. Les gestes sont efficaces et de plus en plus automatisés." },
  { key: 'strategie',   label: "Stratégies d'action",        description: "Utilise des stratégies d'action efficaces en attaque et en défense. Anticipe et prend des décisions tactiques pertinentes." },
  { key: 'cooperation', label: 'Leadership / Coopération',   description: "Exerce un leadership positif au sein de l'équipe. Encourage ses coéquipiers, assume des rôles variés et communique clairement." },
  { key: 'fairplay',    label: 'Fair-play',                  description: "Fait preuve d'un fair-play exemplaire. Respecte les adversaires, les règles et les décisions arbitrales, même sous pression." },
  { key: 'securite',    label: 'Sécurité autonome',          description: "Fait preuve d'autonomie dans l'application des mesures de sécurité. Identifie et gère les risques pour soi et pour les autres." },
  { key: 'sante',       label: 'Habitudes de vie',           description: "Intègre des habitudes de vie saines et actives dans son quotidien. Comprend les liens entre activité physique, alimentation et bien-être." },
]
