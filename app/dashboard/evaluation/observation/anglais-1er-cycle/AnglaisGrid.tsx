  ...
  return (
    <div>
      ...
      <div className="print-table-wrap overflow-x-auto rounded-2xl border border-gray-200 shadow-sm mb-10">
        <table className="border-collapse text-sm" style={{ minWidth: 680 }}>
          <thead>
            <tr>
...
const CRITERIA_FULL = [
  { key: 'participation',  label: 'Participation',  description: "Engages in oral activities willingly. Attempts to speak English, even with limited language." },
  { key: 'vocabulary',     label: 'Vocabulary',     description: "Uses familiar English words, phrases, and expressions learned in class." },
  { key: 'comprehension',  label: 'Comprehension',  description: "Shows understanding of simple spoken English (instructions, songs, short exchanges)." },
  { key: 'strategies',     label: 'Strategies',     description: "Uses communication strategies such as gestures, visuals, repetition, or asking for help." },
  { key: 'turntaking',     label: 'Turn-taking',    description: "Respects turn-taking conventions: waits, listens to others, and responds at the right moment." },
]
