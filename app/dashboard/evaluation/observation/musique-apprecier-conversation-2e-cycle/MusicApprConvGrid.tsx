...
const CRITERIA = [
  { key: 'description',   label: 'Éléments musicaux' },
  { key: 'reaction',      label: 'Réaction personnelle' },
  { key: 'lien',          label: 'Lien avec le vécu' },
  { key: 'caractere',     label: 'Caractère / intention' },
  { key: 'vocabulaire',   label: 'Vocabulaire' },
  { key: 'justification', label: 'Justification' },
  { key: 'interaction',   label: 'Interaction orale' },
] as const
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: "Décrire ce qu'il entend (éléments musicaux simples)",
    sub: "tempo, intensité, timbre, instruments, ambiance",
    levels: {
      4: "Décrit plusieurs éléments musicaux avec des mots justes; nomme des instruments ou des caractéristiques sonores de façon précise.",
      3: "Décrit quelques éléments musicaux; vocabulaire généralement adéquat.",
      2: "Décrit un élément simple (ex. rapide/lent, fort/doux).",
      1: "Description vague, erronée ou absente.",
    },
  },
  {
    key: 'reaction',
    label: "Exprimer une réaction personnelle (oral)",
    sub: "émotions, préférences, ressenti",
    levels: {
      4: "Exprime clairement son ressenti et explique pourquoi il réagit ainsi.",
      3: "Exprime son ressenti avec une courte explication.",
      2: "Exprime une réaction simple sans explication.",
      1: "Réaction absente ou hors sujet.",
    },
  },
  {
    key: 'lien',
    label: "Faire un lien simple avec son vécu ou une expérience",
    sub: "souvenir, situation, image mentale",
    levels: {
      4: "Fait un lien clair et pertinent avec une expérience personnelle ou une situation vécue.",
      3: "Fait un lien simple mais compréhensible.",
  ...
  {
    key: 'caractere',
    label: "Identifier l'intention ou le caractère de la musique",
    sub: "joyeux, calme, mystérieux, énergique…",
    levels: {
      4: "Identifie clairement le caractère de la musique et l'explique avec un élément musical (ex. « C'est calme parce que c'est lent et doux »).",
  ...
  {
    key: 'vocabulaire',
    label: "Utiliser un vocabulaire musical simple (oral)",
    sub: "mots liés au tempo, intensité, timbre, ambiance",
    levels: {
      4: "Utilise spontanément plusieurs mots musicaux simples et appropriés.",
      3: "Utilise quelques mots musicaux adéquats.",
  ...
  },
  {
    ...
    sub: "appuyer ses propos avec un élément entendu",
    levels: {
      4: "Justifie clairement ses propos en nommant un élément musical entendu (ex. « Je trouve ça joyeux parce que c'est rapide »).",
      3: "Donne une justification simple mais pertinente.",
      2: "Justification minimale ou partielle.",
      1: "Aucune justification ou justification non liée à la musique.",
    },
  },
  {
    key: 'interaction',
    label: "Interaction orale en situation d'écoute",
    sub: "écoute, participation, cohérence des réponses",
    levels: {
      4: "Écoute attentivement, répond de façon cohérente, rebondit sur une idée ou pose une question simple.",
      3: "Écoute bien et répond de façon appropriée.",
      2: "Répond lorsqu'interpellé; écoute partielle.",
      1: "Peu ou pas de participation; ne répond pas ou répond hors sujet.",
    },
  },
]
