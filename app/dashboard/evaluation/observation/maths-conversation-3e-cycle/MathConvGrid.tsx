  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Mathématique — Conversation orale</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'comprehension',
    label: "Compréhension de la situation mathématique (oral)",
    sub: "",
    levels: {
      4: "Reformule la situation avec ses mots, identifie les données et le but du problème.",
      3: "Explique la situation avec quelques imprécisions.",
      2: "Comprend partiellement; explication simple ou incomplète.",
      1: "Ne parvient pas à expliquer la situation.",
    },
  },
  {
    key: 'raisonnement',
    label: "Expression du raisonnement et des stratégies",
    sub: "",
    levels: {
      4: "Décrit clairement sa démarche, justifie chaque étape et explique pourquoi elle est pertinente.",
      3: "Décrit sa démarche avec quelques oublis ou hésitations.",
      2: "Évoque une stratégie sans la détailler.",
      1: "Ne parvient pas à expliquer sa démarche.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Utilisation du vocabulaire mathématique",
    sub: "",
    levels: {
      4: "Utilise spontanément un vocabulaire mathématique précis (ex. : fraction, périmètre, équivalence).",
      3: "Utilise le vocabulaire avec quelques erreurs ou oublis.",
      2: "Utilise des mots généraux ou approximatifs.",
      1: "Ne recourt pas au vocabulaire mathématique.",
    },
  },
  {
    key: 'justification',
    label: "Justification et argumentation orale",
    sub: "",
    levels: {
      4: "Justifie ses réponses avec des arguments clairs et des liens entre concepts.",
      3: "Justifie partiellement ou de manière intuitive.",
  ...
  {
    key: 'interaction',
    label: "Interaction et écoute en contexte mathématique",
    sub: "",
    levels: {
      4: "Écoute les autres, rebondit sur leurs idées et reformule avec pertinence.",
      3: "Écoute et répond de façon adéquate.",
      2: "Réagit brièvement ou hors contexte.",
      1: "N'écoute pas ou interrompt sans lien avec le sujet.",
    },
  },
]
