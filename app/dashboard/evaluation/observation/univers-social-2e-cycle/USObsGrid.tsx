...
export default function USObsGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Univers social</h2>
      ...
      <div className="print-table-wrap overflow-x-auto rounded-2xl border border-gray-200 shadow-sm mb-10">
        <table className="border-collapse text-sm" style={{ minWidth: 760 }}>
          <thead>
            <tr>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour s'engager dans les tâches d'univers social.",
  2: "L'élève progresse avec l'accompagnement de l'enseignant ou des pairs.",
  3: "L'élève maîtrise le critère de façon autonome.",
  4: "L'élève dépasse les attentes et enrichit les discussions du groupe.",
}

const CRITERIA_FULL = [
  { key: 'reperage',      label: 'Repérage',      description: "Trouve l'information demandée dans un document (image, carte, texte court)." },
  { key: 'temps',         label: 'Temps',          description: "Situe un événement dans l'ordre (avant / après / aujourd'hui / autrefois)." },
  { key: 'espace',        label: 'Espace',         description: "Lit une carte simple et localise un lieu à l'aide de la légende." },
  { key: 'sources',       label: 'Sources',        description: "Observe deux documents et nomme une ressemblance ou une différence." },
  { key: 'analyse',       label: 'Analyse',        description: "Fait un lien simple entre deux éléments (ex. cause → effet)." },
  { key: 'communication', label: 'Communication',  description: "Explique ses idées clairement avec un vocabulaire de base." },
  { key: 'collaboration', label: 'Collaboration',  description: "Participe à la tâche, partage le matériel et écoute les autres." },
]
