  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — 2e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour organiser et réviser ses textes.",
  2: "L'élève organise et révise ses textes avec l'accompagnement de l'enseignant.",
  3: "L'élève applique le processus d'écriture de façon autonome et structurée.",
  4: "L'élève applique le processus d'écriture avec aisance, nuance et efficacité.",
}

const CRITERIA_FULL = [
  { key: 'planification',  label: 'Planification',          description: "Élabore un plan ou une carte d'idées adapté au type de texte et à l'intention d'écriture." },
  { key: 'organisation',   label: 'Organisation des idées', description: "Délimite ses paragraphes et assure une progression logique entre les idées." },
  { key: 'coherence',      label: 'Cohérence textuelle',    description: "Maintient la cohérence entre les paragraphes à l'aide de référents et de connecteurs variés." },
  { key: 'revision',       label: 'Révision',               description: "Cible ses révisions sur le sens, la structure et la clarté des idées." },
  { key: 'autocorrection', label: 'Autocorrection',         description: "Utilise des stratégies d'orthographe et de grammaire pour corriger ses erreurs." },
  { key: 'amelioration',   label: 'Amélioration du texte',  description: "Reformule et enrichit son texte de façon autonome à partir de ses révisions." },
]
