...
export default async function Ecriture2eCyclePrintAllPage({
  searchParams,
}: {
  ...
  if (!etape) redirect('/dashboard/evaluation/observation/ecriture-2e-cycle')
  ...
  return (
    <>
      ...
      <div className="p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Français — Écriture — 2e cycle</h1>
