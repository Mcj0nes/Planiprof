...
const CRITERIA = [
  { key: 'decodage',      label: 'Décodage / Fluidité' },
  { key: 'comprehension', label: 'Compréhension' },
  { key: 'strategies',    label: 'Stratégies' },
  { key: 'vocabulaire',   label: 'Vocabulaire' },
  { key: 'prediction',    label: 'Anticipation' },
  { key: 'reaction',      label: 'Réaction au texte' },
] as const
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève décode avec difficulté; comprend peu le texte et a besoin d'un soutien constant pour accéder au sens.",
  2: "L'élève décode avec aide; comprend les informations les plus explicites et commence à utiliser quelques stratégies.",
  3: "L'élève lit avec fluidité; comprend l'essentiel du texte de façon autonome et utilise les stratégies appropriées.",
  4: "L'élève dépasse les attentes : lecture fluide, compréhension approfondie, réactions riches et stratégies variées.",
}

const CRITERIA_FULL = [
  { key: 'decodage',      label: 'Décodage / Fluidité',  description: "Reconnaît les correspondances graphème-phonème et lit avec une fluidité croissante. Les mots fréquents sont automatisés." },
  { key: 'comprehension', label: 'Compréhension',         description: "Comprend les informations explicites d'un texte simple (qui, quoi, où, quand). Peut répondre à des questions directes." },
  { key: 'strategies',    label: 'Stratégies',            description: "Utilise des stratégies de dépannage (images, contexte, relecture, segmentation) pour comprendre les mots ou passages difficiles." },
  { key: 'vocabulaire',   label: 'Vocabulaire',           description: "Comprend le sens de mots courants dans le contexte du texte. Utilise le contexte ou les illustrations pour inférer le sens." },
  { key: 'prediction',    label: 'Anticipation',          description: "Fait des prédictions sur le contenu à partir du titre, des illustrations ou du début du texte. Confirme ou ajuste ses prédictions." },
  { key: 'reaction',      label: 'Réaction au texte',     description: "Exprime une réaction personnelle simple (aime/n'aime pas, surprise, intérêt) et peut en donner une raison élémentaire." },
]
