...
export default function SciencesGrid({
...
const CRITERIA_FULL = [
  { key: 'hypothese',     label: 'Hypothèse',     description: 'Propose une explication logique et justifiée.' },
  { key: 'manipulation',  label: 'Manipulation',   description: 'Manipule le matériel avec méthode et sécurité.' },
  { key: 'observation',   label: 'Observation',    description: 'Observe et décrit des faits précis.' },
  { key: 'analyse',       label: 'Analyse',        description: 'Explique les résultats et identifie des liens.' },
  { key: 'conclusion',    label: 'Conclusion',     description: 'Ajuste et approfondit sa compréhension du phénomène.' },
  { key: 'communication', label: 'Communication',  description: 'Explique clairement avec un vocabulaire scientifique.' },
  { key: 'collaboration', label: 'Collaboration',  description: 'Travaille efficacement et coopère en équipe.' },
]
