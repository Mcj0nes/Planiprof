...
const CRITERIA = [
  { key: 'analyse',     label: 'Analyse motrice' },
  { key: 'strategies',  label: 'Stratégies' },
  { key: 'regles',      label: 'Règles et fair-play' },
  { key: 'cooperation', label: 'Leadership / coopération' },
  { key: 'sante',       label: 'Mode de vie actif' },
  { key: 'autoeval',    label: 'Autoévaluation' },
] as const
...
export default function EducPhysiqueConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Éducation physique — Conversation orale — 3e cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'analyse',
    label: 'Analyser ses actions et démarche motrice',
    sub: '',
    levels: {
      4: "Analyse ses actions motrices avec précision; explique les ajustements effectués, les effets produits et les liens avec les principes d'efficacité.",
      3: "Analyse ses actions avec pertinence, avec quelques lacunes dans l'explication.",
      2: "Décrit ses actions sans les analyser ni proposer d'ajustements.",
      1: "Ne parvient pas à analyser ses actions motrices.",
    },
  },
  {
    key: 'strategies',
    label: 'Expliquer et justifier des stratégies',
    sub: '',
    levels: {
      4: "Explique, justifie et compare des stratégies collectives ou individuelles; propose des ajustements en fonction des forces et faiblesses de l'équipe.",
      3: "Explique une stratégie pertinente avec quelques imprécisions dans la justification.",
      2: "Mentionne une stratégie sans la développer ni la justifier.",
      1: "Ne parvient pas à expliquer une stratégie de jeu.",
    },
  },
  {
    key: 'regles',
    label: 'Règles du jeu, arbitrage et fair-play',
    sub: '',
    levels: {
      4: "Explique les règles en détail, discute des situations litigieuses et défend l'importance du fair-play avec des arguments solides.",
      3: "Explique les règles et mentionne le fair-play avec quelques imprécisions.",
      2: "Nomme les règles principales sans aborder le fair-play.",
      1: "Ne parvient pas à expliquer les règles ou le fair-play.",
    },
  },
  {
    key: 'cooperation',
    label: 'Leadership, coopération et communication',
    sub: '',
    levels: {
      4: "Décrit son rôle dans l'équipe; explique comment il/elle a communiqué, guidé ou encouragé ses coéquipiers; donne des exemples concrets.",
      3: "Décrit sa contribution à l'équipe avec quelques hésitations.",
      2: "Mentionne avoir participé en équipe sans décrire son rôle spécifique.",
      1: "Ne parvient pas à décrire sa contribution à la coopération d'équipe.",
    },
  },
  {
    key: 'sante',
    label: 'Mode de vie sain et actif',
    sub: '',
    levels: {
      4: "Fait des liens nuancés entre l'activité physique régulière, la santé et le bien-être; propose des habitudes concrètes et les justifie.",
      3: "Fait des liens pertinents avec le mode de vie actif avec quelques imprécisions.",
      2: "Mentionne l'importance de bouger sans approfondir le lien avec la santé.",
      1: "Ne fait pas de lien entre activité physique et mode de vie sain.",
    },
  },
  {
    key: 'autoeval',
    label: 'Autoévaluation et ajustement',
    sub: '',
    levels: {
      4: "Évalue sa performance de façon critique et nuancée; identifie clairement ses forces, ses défis et propose un plan d'amélioration concret.",
      3: "Identifie forces et défis avec quelques manques de précision.",
      2: "Évalue sa performance de façon générale sans proposer d'ajustements.",
      1: "Ne parvient pas à s'autoévaluer de façon pertinente.",
    },
  },
]
