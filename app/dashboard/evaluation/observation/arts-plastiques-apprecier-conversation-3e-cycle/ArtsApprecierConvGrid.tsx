...
const CRITERIA = [
  ...
  { key: 'analyse',      label: 'Analyse plastique' },
  { key: 'contexte',     label: 'Contexte' },
  { key: 'reaction',     label: 'Interprétation' },
  { key: 'jugement',     label: 'Jugement critique' },
...
export default function ArtsApprecierConvGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Apprécier — Conversation orale — 3e cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    key: 'description',
    label: 'Description',
    sub: 'Décrire les éléments visuels',
    levels: {
      4: "Décrit l'œuvre de façon détaillée et organisée (composition, plan, couleur, forme, matière, technique).",
      3: "Décrit plusieurs éléments avec quelques imprécisions ou oublis.",
      2: "Décrit seulement les éléments les plus évidents sans organisation.",
      1: "Ne parvient pas à décrire l'œuvre de façon cohérente.",
    },
  },
  {
    key: 'analyse',
    label: 'Analyse plastique',
    sub: 'Analyser les éléments plastiques',
    levels: {
      4: "Analyse les choix plastiques (ex. : contraste, rythme, espace, point focal) et explique leurs effets sur le spectateur.",
      3: "Identifie et explique quelques éléments plastiques avec quelques lacunes.",
      2: "Nomme des éléments plastiques sans en expliquer les effets.",
      1: "N'analyse pas les éléments plastiques de l'œuvre.",
    },
  },
  {
    key: 'contexte',
    label: 'Contexte',
    sub: "Mettre l'œuvre en contexte",
    levels: {
      4: "Situe l'œuvre dans son contexte historique, culturel ou stylistique et établit des liens avec d'autres œuvres ou artistes.",
      3: "Mentionne le contexte avec quelques imprécisions ou liens incomplets.",
      2: "Connaît partiellement le contexte mais peine à l'articuler oralement.",
      1: "Ne tient pas compte du contexte dans son appréciation.",
    },
  },
  {
    key: 'reaction',
    label: 'Interprétation',
    sub: "Interpréter et réagir à l'œuvre",
    levels: {
      4: "Formule une interprétation personnelle nuancée, appuyée sur des éléments de l'œuvre, et l'exprime oralement avec assurance.",
      3: "Exprime une interprétation pertinente avec quelques hésitations.",
      2: "Réagit à l'œuvre de façon superficielle sans interprétation développée.",
      1: "Ne parvient pas à interpréter ou réagir à l'œuvre.",
    },
  },
  {
    key: 'jugement',
    label: 'Jugement critique',
    sub: 'Formuler un jugement critique argumenté',
    levels: {
      4: "Formule un jugement critique structuré, avec des arguments fondés sur les éléments de l'œuvre, le contexte et l'intention de l'artiste.",
      3: "Formule un jugement pertinent avec quelques manques de rigueur.",
      2: "Exprime une préférence sans argumenter de façon critique.",
      1: "Ne formule pas de jugement critique ou utilise des arguments non pertinents.",
    },
  },
  {
    key: 'vocabulaire',
    label: 'Vocabulaire',
    sub: 'Utiliser le vocabulaire artistique précis',
    levels: {
      4: "Utilise spontanément un vocabulaire artistique riche et précis (ex. : monochrome, perspective, composition, médium, intention artistique).",
      3: "Utilise le vocabulaire artistique avec quelques erreurs ou hésitations.",
      2: "Utilise des mots généraux avec peu de vocabulaire artistique précis.",
      1: "N'utilise pas de vocabulaire artistique.",
    },
  },
]
