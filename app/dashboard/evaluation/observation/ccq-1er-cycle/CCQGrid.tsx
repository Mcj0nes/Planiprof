...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève nécessite un soutien constant pour participer aux activités et réfléchir sur des questions simples.",
  2: "L'élève participe avec l'aide de l'enseignant ou des pairs; exprime des idées simples sur les sujets abordés.",
  3: "L'élève s'engage de façon autonome, exprime son point de vue et respecte les règles du dialogue.",
  4: "L'élève dépasse les attentes : questionnement approfondi, écoute exemplaire, contributions enrichissantes.",
}

const CRITERIA_FULL = [
  { key: 'engagement',     label: 'Engagement',             description: "Participe activement aux activités de CCQ. Montre de l'intérêt pour les sujets éthiques et culturels proposés." },
  { key: 'questionnement', label: 'Questionnement',          description: "Pose des questions sur des réalités culturelles ou éthiques simples. Cherche à comprendre ce qui l'entoure." },
  { key: 'valeurs',        label: 'Valeurs / Émotions',      description: "Reconnaît des émotions et des valeurs dans des situations vécues ou des histoires. Peut les nommer simplement." },
  { key: 'ecoute',         label: 'Écoute',                  description: "Écoute sans interrompre lorsqu'un camarade parle. Montre de l'intérêt pour les points de vue des autres." },
  { key: 'dialogue',       label: 'Expression',              description: "Exprime son point de vue de façon simple et respectueuse lors des échanges en groupe." },
  { key: 'respect',        label: 'Respect du dialogue',     description: "Respecte les règles de base du dialogue : lever la main, attendre son tour, parler avec respect." },
]
