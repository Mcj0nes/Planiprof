...
export default async function SciConversation2ePrintAllPage({
  searchParams,
}: {
  ...
  if (!etape) redirect('/dashboard/evaluation/observation/sciences-conversation-2e-cycle')
  ...
  return (
    <>
      ...
      <div className="p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Sciences — Conversation orale — 2e cycle</h1>
