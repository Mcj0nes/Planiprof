...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: "compréhension du phénomène, du problème ou de la question scientifique",
    levels: {
      4: "Explique clairement la situation scientifique avec ses propres mots; identifie spontanément les éléments importants.",
      3: "Explique la situation avec quelques hésitations; compréhension généralement juste.",
  ...
  {
    key: 'hypothese',
    label: "Formuler une prédiction ou une hypothèse simple (oral)",
    sub: "habileté centrale de la démarche scientifique au 2e cycle",
    levels: {
      4: "Formule une prédiction claire et logique en expliquant brièvement pourquoi.",
      3: "Formule une prédiction plausible mais peu expliquée.",
      2: "Prédiction simple ou partiellement liée à la situation.",
      1: "Prédiction absente, illogique ou non liée à la situation.",
    },
  },
  {
    key: 'demarche',
    label: "Décrire une démarche ou une procédure simple (oral)",
    sub: "comment vérifier, observer, tester",
    levels: {
      4: "Décrit oralement une démarche simple mais complète; explique pourquoi une étape est importante.",
  ...
  {
    key: 'interpretation',
    label: "Décrire et interpréter des observations (oral)",
    sub: "ce qu'il voit, ce que ça montre, ce que ça veut dire",
    levels: {
      4: "Décrit clairement ce qu'il observe et explique ce que cela signifie de façon simple et juste.",
      3: "Décrit ce qu'il observe; interprétation partielle mais correcte.",
      2: "Décrit une observation sans interprétation.",
      1: "Description vague, erronée ou absente.",
    },
  },
  {
    key: 'connaissances',
    label: "Utiliser un vocabulaire scientifique simple (oral)",
    sub: "mots liés aux propriétés, matériaux, forces, transformations, etc.",
    levels: {
      4: "Utilise spontanément plusieurs mots scientifiques simples et appropriés.",
      3: "Utilise quelques mots scientifiques adéquats.",
      2: "Utilise un vocabulaire simple mais juste.",
      1: "Vocabulaire scientifique absent ou incorrect.",
    },
  },
  {
    key: 'justification',
    label: "Justifier ses idées oralement",
    sub: "appuyer ses propos avec une observation, un fait ou une connaissance simple",
    levels: {
      4: "Justifie clairement ses réponses en nommant un fait, une observation ou une connaissance simple.",
      3: "Donne une justification pertinente mais brève.",
      2: "Justification minimale ou partielle.",
