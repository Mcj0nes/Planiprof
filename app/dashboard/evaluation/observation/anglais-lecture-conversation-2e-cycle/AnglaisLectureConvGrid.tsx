...
const CRITERIA = [
  ...
  { key: 'characters', label: 'Characters & Events' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">English — Reading — Oral Conversation — Cycle 2</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'main_idea',
    label: 'Identify and explain the main idea',
    sub: '',
    levels: {
      4: 'Clearly explains the main idea of the text in complete English sentences, supported by details from the text.',
      3: 'Identifies the main idea with some imprecision or missing details.',
      2: 'Names a detail from the text without identifying the main idea.',
      1: 'Cannot identify the main idea of the text.',
    },
  },
  {
    key: 'characters',
    label: 'Describe characters and key events',
    sub: '',
    levels: {
      4: 'Accurately describes the main character(s) with adjectives and recounts key events in sequence.',
      3: 'Describes characters or events with some gaps or errors.',
      2: 'Names a character or event without description.',
      1: 'Cannot describe characters or recount events in English.',
    },
  },
  {
    key: 'inference',
    label: 'Make simple inferences',
    sub: '',
    levels: {
      4: "Makes a logical inference about a character's feelings or unstated information and supports it with evidence from the text.",
      3: 'Makes an inference with some support or partial explanation.',
  ...
  {
    key: 'vocabulary',
    label: 'Use and explain vocabulary from the text',
    sub: '',
    levels: {
      4: 'Uses several words from the text correctly in context and explains their meaning using simple English (definition, example, or synonym).',
      3: 'Uses vocabulary from the text with some errors or limited explanation.',
      2: 'Repeats a word from the text but cannot explain it.',
      1: 'Does not use or recognize vocabulary from the text.',
    },
  },
  {
    key: 'connection',
    label: 'Make text-to-self or text-to-world connections',
    sub: '',
    levels: {
      4: 'Makes a clear connection between the text and personal experience or the world, explaining the link in English.',
      3: 'Makes a connection with some hesitation or limited explanation.',
      2: 'Mentions a connection but cannot express it in English.',
      1: 'Cannot make a connection to the text.',
    },
  },
  {
    key: 'opinion',
    label: 'Express an opinion about the text',
    sub: '',
    levels: {
      4: 'Gives a clear opinion about the text and supports it with at least one reason in English (e.g., "I liked this book because the ending was surprising").',
      3: 'Expresses an opinion with limited justification.',
      2: 'Expresses a simple preference (e.g., "I liked it") without explanation.',
      1: 'Cannot express an opinion about the text in English.',
    },
  },
]
