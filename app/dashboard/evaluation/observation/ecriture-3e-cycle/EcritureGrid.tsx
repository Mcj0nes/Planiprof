...
const CRITERIA = [
  ...
  { key: 'organisation',   label: 'Organisation des idées' },
  { key: 'coherence',      label: 'Cohérence' },
  { key: 'revision',       label: 'Révision' },
  { key: 'autocorrection', label: 'Autocorrection' },
...
export default function EcritureGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Français — Écriture — 3e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour planifier, organiser et réviser ses textes.",
  2: "L'élève planifie et révise ses textes avec l'accompagnement de l'enseignant.",
  3: "L'élève maîtrise le processus d'écriture et l'applique de façon autonome.",
  4: "L'élève applique le processus d'écriture avec finesse, rigueur et créativité.",
}

const CRITERIA_FULL = [
  { key: 'planification',  label: 'Planification',          description: "Élabore un plan détaillé adapté au genre textuel, à l'intention et au destinataire." },
  { key: 'organisation',   label: 'Organisation des idées', description: "Assure une progression logique avec des transitions claires entre les idées et les paragraphes." },
  { key: 'coherence',      label: 'Cohérence textuelle',    description: "Maintient la cohérence tout au long du texte (reprise de l'information, connecteurs, tonalité)." },
  { key: 'revision',       label: 'Révision',               description: "Révise son texte de façon multidimensionnelle (sens, structure, style, vocabulaire)." },
  { key: 'autocorrection', label: 'Autocorrection',         description: "Applique ses connaissances grammaticales avec précision pour corriger ses erreurs." },
  { key: 'amelioration',   label: 'Amélioration du texte',  description: "Révise en profondeur en reformulant, en enrichissant le vocabulaire et en soignant le style." },
]
