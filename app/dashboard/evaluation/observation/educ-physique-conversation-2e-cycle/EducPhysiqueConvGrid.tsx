...
const CRITERIA = [
  { key: 'description',  label: 'Décrire ses actions' },
  { key: 'strategies',   label: 'Stratégies' },
  { key: 'regles',       label: 'Règles et arbitrage' },
  { key: 'cooperation',  label: 'Coopération' },
  { key: 'sante',        label: 'Santé et bien-être' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Éducation physique — Conversation orale — 2e cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: 'Décrire ses actions et démarche motrice',
    sub: '',
    levels: {
      4: 'Décrit avec précision ses actions et sa démarche motrice (ex. : « j\'ai plié les genoux pour mieux sauter, puis j\'ai regardé ma cible »); utilise des termes moteurs appropriés.',
      3: 'Décrit ses actions de façon généralement claire avec quelques imprécisions.',
      2: 'Décrit brièvement ses actions sans détailler sa démarche.',
      1: 'Ne parvient pas à décrire ses actions ou sa démarche motrice.',
    },
  },
  {
    key: 'strategies',
    label: 'Expliquer une stratégie de jeu',
    sub: '',
    levels: {
      4: 'Explique clairement une stratégie collective ou individuelle et justifie son efficacité dans le contexte du jeu.',
      3: 'Explique une stratégie pertinente avec quelques lacunes.',
      2: 'Mentionne une stratégie sans l\'expliquer clairement.',
      1: 'Ne parvient pas à expliquer une stratégie de jeu.',
    },
  },
  {
    key: 'regles',
    label: 'Comprendre et expliquer les règles',
    sub: '',
    levels: {
      4: 'Explique les règles du jeu avec précision, donne des exemples et mentionne l\'importance du fair-play.',
      3: 'Explique les règles principales avec quelques imprécisions.',
      2: 'Nomme quelques règles sans les expliquer.',
      1: 'Ne parvient pas à expliquer les règles du jeu.',
    },
  },
  {
    key: 'cooperation',
    label: 'Coopération et communication en équipe',
    sub: '',
    levels: {
      4: 'Décrit comment il/elle a communiqué et coopéré avec son équipe; nomme des exemples de gestes coopératifs (encourager, signaler, s\'organiser).',
      3: 'Décrit une forme de coopération avec quelques hésitations.',
      2: 'Mentionne avoir coopéré sans donner d\'exemples précis.',
      1: 'Ne parvient pas à décrire comment il/elle a coopéré en équipe.',
    },
  },
  {
    key: 'sante',
    label: 'Liens avec la santé et le bien-être',
    sub: '',
    levels: {
      4: 'Fait des liens entre l\'activité physique et la santé; explique l\'importance de bouger régulièrement avec des arguments concrets.',
      3: 'Fait un lien pertinent avec la santé avec quelques imprécisions.',
      2: 'Mentionne un bienfait de l\'activité physique sans l\'expliquer.',
      1: 'Ne fait pas de lien entre l\'activité physique et la santé.',
    },
  },
  {
    key: 'autoeval',
    label: 'Réflexion sur sa performance',
    sub: '',
    levels: {
      4: 'Réfléchit sur sa performance : nomme ses points forts, identifie ce qu\'il/elle veut améliorer et propose un moyen concret de le faire.',
      3: 'Identifie un point fort et un point à améliorer avec quelques hésitations.',
      2: 'Évalue sa performance de façon très générale.',
      1: 'Ne parvient pas à réfléchir sur sa performance.',
    },
  },
]
