...
const CRITERIA = [
  { key: 'ecoute',       label: 'Écoute analytique' },
  { key: 'description',  label: 'Analyse des éléments' },
  { key: 'reaction',     label: 'Réaction nuancée' },
  { key: 'vocabulaire',  label: 'Vocabulaire spécialisé' },
  { key: 'contexte',     label: 'Contexte socioculturel' },
  { key: 'comparaison',  label: 'Mise en relation' },
...
export default function MusiqueApprecierGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Apprécier — 3e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour apprécier et analyser une œuvre musicale.",
  2: "L'élève apprécie la musique avec l'accompagnement de l'enseignant.",
  3: "L'élève apprécie, analyse et justifie ses jugements de façon autonome.",
  4: "L'élève formule des appréciations critiques nuancées, bien argumentées, en tenant compte du contexte.",
}

const CRITERIA_FULL = [
  { key: 'ecoute',      label: 'Écoute analytique',        description: 'Écoute avec intention, repère des détails musicaux significatifs.' },
  { key: 'description', label: 'Analyse des éléments',     description: 'Analyse plusieurs éléments musicaux avec précision (forme, harmonie, timbre, nuances, rythme).' },
  { key: 'reaction',    label: 'Réaction nuancée',         description: 'Exprime une réaction personnelle nuancée et l\'associe à des observations musicales précises.' },
  { key: 'vocabulaire', label: 'Vocabulaire spécialisé',   description: 'Utilise avec aisance le vocabulaire musical spécialisé du programme.' },
  { key: 'contexte',    label: 'Contexte socioculturel',   description: 'Situe l\'œuvre dans son contexte historique, géographique ou culturel.' },
  { key: 'comparaison', label: 'Mise en relation',         description: 'Compare et met en relation plusieurs œuvres en relevant leurs similitudes et leurs différences.' },
  { key: 'jugement',    label: 'Jugement critique',        description: 'Formule un jugement esthétique critique étayé par des arguments musicaux et contextuels.' },
]
