  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour s'engager dans sa démarche créative.",
  2: "L'élève progresse avec l'accompagnement de l'enseignant ou des pairs.",
  3: "L'élève maîtrise le critère de façon autonome.",
  4: "L'élève dépasse les attentes et fait preuve d'une créativité remarquable.",
}

const CRITERIA_FULL = [
  { key: 'intention',    label: 'Intention / Idée de départ',     description: "Exprime une idée personnelle ou un message à travers sa création. Explique ce qu'il veut représenter ou faire ressentir." },
  { key: 'exploration',  label: 'Exploration / Expérimentation',   description: "Essaie différentes façons de faire (techniques, matériaux, couleurs, formes). Fait des essais, ajuste, prend des initiatives." },
  { key: 'organisation', label: 'Organisation / Composition',      description: "Organise les éléments visuels de façon équilibrée et réfléchie. Utilise l'espace, les contrastes, les formes et les couleurs avec intention." },
  { key: 'maitrise',     label: 'Maîtrise technique',              description: "Utilise les outils et matériaux de manière adéquate et sécuritaire. Applique les techniques enseignées avec soin et précision." },
  { key: 'observation',  label: 'Observation / Référence',         description: "Observe des œuvres ou des éléments du réel pour s'en inspirer. Reproduit ou transforme des détails pertinents dans sa création." },
  { key: 'reflexion',    label: 'Réflexion / Analyse',             description: "Explique ses choix et ce qu'il a appris de sa démarche. Compare son intention de départ et le résultat obtenu." },
]
