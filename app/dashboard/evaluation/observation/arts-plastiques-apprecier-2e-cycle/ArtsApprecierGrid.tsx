  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Arts plastiques — Apprécier — 2e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour analyser et apprécier une œuvre.",
  2: "L'élève décrit et analyse une œuvre avec l'accompagnement de l'enseignant.",
  3: "L'élève apprécie une œuvre de façon autonome, en s'appuyant sur ses observations.",
  4: "L'élève formule une appréciation nuancée et argumentée, enrichie d'éléments contextuels.",
}

const CRITERIA_FULL = [
  { key: 'observation', label: 'Observation de l\'œuvre',      description: "Observe méthodiquement une œuvre en repérant différents éléments visuels." },
  { key: 'description', label: 'Description des éléments',     description: "Décrit les éléments formels et expressifs de l'œuvre : couleurs, textures, lignes, composition." },
  { key: 'analyse',     label: 'Langage plastique',            description: "Repère et nomme plusieurs éléments du langage plastique et explique leur rôle dans l'œuvre." },
  { key: 'reaction',    label: 'Réaction personnelle',         description: "Exprime une réaction nuancée en distinguant ce qu'il ressent de ce qu'il observe." },
  { key: 'contexte',    label: 'Mise en contexte',             description: "Situe l'œuvre dans un contexte artistique ou culturel simple : genre, époque, lieu, intention de l'artiste." },
  { key: 'jugement',    label: 'Jugement esthétique',          description: "Formule un jugement esthétique appuyé sur des observations précises." },
]
