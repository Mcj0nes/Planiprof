...
const CRITERIA = [
  ...
  { key: 'description', label: 'Description sonore' },
  { key: 'reaction',    label: 'Réaction affective' },
  { key: 'vocabulaire', label: 'Vocabulaire musical' },
  { key: 'liens',       label: 'Associations' },
  { key: 'jugement',    label: 'Jugement personnel' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Apprécier — 1er cycle</h2>
...
const CRITERIA_FULL = [
  { key: 'ecoute',      label: 'Écoute active',         description: 'Reste attentif pendant l\'écoute d\'une œuvre et manifeste une présence engagée.' },
  { key: 'description', label: 'Description sonore',    description: 'Identifie des éléments simples (fort/doux, rapide/lent, timbre d\'un instrument).' },
  { key: 'reaction',    label: 'Réaction affective',    description: 'Exprime spontanément ce que la musique lui fait ressentir (joie, peur, calme...).' },
  { key: 'vocabulaire', label: 'Vocabulaire musical',   description: 'Utilise des mots simples du programme pour parler de la musique.' },
  { key: 'liens',       label: 'Associations',          description: 'Associe la musique à une image, une histoire, un souvenir ou une émotion.' },
  { key: 'jugement',    label: 'Jugement personnel',    description: 'Dit ce qu\'il aime ou n\'aime pas dans une œuvre et tente d\'expliquer pourquoi.' },
]
