...
const CRITERIA = [
  ...
  { key: 'evaluation',    label: 'Réagir à sa création' },
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: "sons choisis, tempo, nuances, structure simple",
    levels: {
      4: "Décrit sa création en nommant plusieurs éléments (tempo, nuances, sons, structure); vocabulaire juste.",
      3: "Décrit sa création en mentionnant quelques éléments.",
      2: "Décrit sa création simplement (ex. rapide, fort).",
      1: "Description vague ou absente.",
    },
  },
  {
    key: 'choix',
    label: "Expliquer ses choix",
    sub: "pourquoi ces sons, ce rythme, cette dynamique",
    levels: {
  ...
  },
  {
    ...
    sub: "ambiance, émotion voulue dans la pièce",
    levels: {
      4: "Exprime clairement l'intention et la relie à des choix musicaux.",
      3: "Exprime une intention simple avec un lien à la musique.",
  ...
  },
  {
    ...
    levels: {
      ...
      1: "Incapable de réagir à sa création.",
    },
  },
  {
    key: 'vocabulaire',
    label: "Vocabulaire musical (2e cycle)",
    sub: "tempo, nuances, rythme, mélodie, dynamique",
    levels: {
      4: "Utilise plusieurs mots musicaux appropriés au 2e cycle.",
      3: "Utilise quelques mots musicaux adéquats.",
      2: "Utilise quelques mots simples (fort/doux, rapide/lent).",
  ...
  },
  {
    ...
    sub: "donner une raison liée à la musique créée",
    levels: {
      4: "Justifie ses idées avec plusieurs raisons liées à sa création.",
