...
const CRITERIA = [
  ...
  { key: 'reflexion',     label: 'Réflexion éthique' },
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">CCQ — Conversation orale — 2e cycle</h2>
...
const CRITERIA_FULL: {
...
}[] = [
  {
    ...
    sub: '',
    levels: {
      4: "S'engage pleinement dans la discussion, partage ses idées et apporte des éléments nouveaux liés au thème éthique ou citoyen.",
      3: 'Participe activement et de façon pertinente avec quelques hésitations.',
      2: "Participe peu; répond si sollicité mais n'initie pas d'échanges.",
      1: "Ne participe pas ou s'éloigne du sujet.",
    },
  },
  {
    key: 'reflexion',
    label: 'Réflexion éthique',
    sub: '',
    levels: {
      4: 'Formule une réflexion personnelle nuancée sur la question éthique ou citoyenne, avec des exemples concrets.',
      3: 'Partage une réflexion personnelle pertinente avec quelques imprécisions.',
      2: "Exprime une idée simple sans l'approfondir.",
      1: 'Ne parvient pas à formuler une réflexion sur la question posée.',
    },
  },
  {
    key: 'perspective',
    label: 'Prise en compte de perspectives',
    sub: '',
    levels: {
      4: 'Reconnaît différents points de vue et les intègre dans sa réflexion.',
      3: "Reconnaît d'autres points de vue, avec quelques difficultés à les articuler.",
      2: "Mentionne d'autres points de vue sans les expliquer.",
      1: 'Ne tient pas compte des autres perspectives.',
    },
  },
  {
    key: 'ecoute',
    ...
    sub: '',
    levels: {
      4: 'Écoute attentivement, reformule les idées des autres et y répond de façon pertinente.',
      3: 'Écoute généralement bien et réagit adéquatement.',
  ...
  {
    key: 'dialogue',
    label: 'Dialogue constructif',
    sub: '',
    levels: {
      4: 'Participe de façon constructive; reformule, questionne et relance le dialogue.',
      3: 'Dialogue de façon généralement constructive avec quelques imprécisions.',
      2: 'Intervient sans toujours tenir compte du fil de la discussion.',
      1: "N'intervient pas de façon constructive dans le dialogue.",
    },
  },
  {
    key: 'argumentation',
    ...
    sub: '',
    levels: {
      4: 'Justifie son point de vue avec des arguments clairs, des exemples et des liens avec les valeurs citoyennes.',
      3: 'Donne un ou deux arguments pertinents avec quelques lacunes.',
      2: "Exprime une opinion sans l'argumenter clairement.",
      1: 'Ne justifie pas son point de vue.',
    },
  },
]
