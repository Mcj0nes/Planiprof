...
const CRITERIA = [
  ...
  { key: 'questionnement', label: 'Questionnement' },
  { key: 'valeurs',        label: 'Valeurs / Émotions' },
  { key: 'ecoute',         label: 'Écoute' },
  { key: 'expression',     label: 'Expression orale' },
  { key: 'respect',        label: 'Respect du dialogue' },
] as const
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">CCQ — Conversation orale — 1er cycle</h2>
...
const CRITERIA_FULL: {
  ...
  {
    key: 'engagement',
    label: 'Engagement dans la discussion',
    sub: '',
    levels: {
      4: "Participe activement, prend la parole spontanément et apporte des idées personnelles liées au sujet.",
      3: "Participe régulièrement et apporte des contributions pertinentes.",
      2: "Participe peu; répond surtout si sollicité.",
      1: "N'intervient pas ou s'éloigne du sujet.",
    },
  },
  {
    key: 'questionnement',
    label: 'Questionnement et curiosité',
    sub: '',
    levels: {
      4: "Pose des questions pertinentes qui approfondissent la discussion.",
      3: "Pose des questions en lien avec le sujet, avec quelques imprécisions.",
      2: "Pose des questions simples ou fermées.",
      1: "Ne pose pas de questions ou hors sujet.",
    },
  },
  {
    key: 'valeurs',
    label: 'Expression des valeurs et émotions',
    sub: '',
    levels: {
      4: "Nomme ses valeurs ou émotions en lien avec la situation et les explique clairement.",
      3: "Nomme ses valeurs ou émotions avec quelques hésitations.",
      2: "Exprime vaguement ce qu'il ressent sans lien clair avec la situation.",
      1: "Ne parvient pas à nommer ses valeurs ou émotions.",
    },
  },
  {
    key: 'ecoute',
    label: 'Écoute et respect de l’autre',
    sub: '',
    levels: {
      4: "Écoute attentivement, attend son tour et réagit aux idées des autres de façon pertinente.",
      3: "Écoute généralement bien et attend son tour.",
      2: "Écoute parfois; peut interrompre ou ne pas tenir compte des autres.",
  ...
  },
  {
    ...
    sub: '',
    levels: {
      4: "S'exprime clairement, avec des phrases complètes et un vocabulaire varié adapté au sujet.",
      3: "S'exprime clairement avec quelques maladresses.",
      2: "S'exprime avec difficulté; phrases incomplètes ou vocabulaire limité.",
      1: "Ne parvient pas à s'exprimer oralement de façon compréhensible.",
    },
  },
  {
    key: 'respect',
    label: 'Respect des règles du dialogue',
    sub: '',
    levels: {
      4: "Respecte toujours les règles (lever la main, écouter, parler à son tour) et encourage les autres à le faire.",
      3: "Respecte généralement les règles avec quelques oublis.",
      2: "Respecte les règles de façon inégale; rappels nécessaires.",
      1: "Ne respecte pas les règles du dialogue.",
    },
  },
]
