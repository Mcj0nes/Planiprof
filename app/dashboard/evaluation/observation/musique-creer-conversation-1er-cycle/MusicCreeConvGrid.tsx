...
const CRITERIA = [
  ...
  { key: 'vocabulaire',  label: 'Vocabulaire de base' },
...
const CRITERIA_FULL: {
  ...
  {
    key: 'description',
    label: "Décrire ce qu'on a créé (oral)",
    sub: "sons utilisés, tempo, instrument",
    levels: {
      4: "Décrit plusieurs aspects de sa création avec des mots précis pour son niveau (ex. fort, lent, tambour).",
      3: "Décrit sa création en nommant deux éléments ou plus.",
      2: "Décrit sa création avec un seul élément (ex. « c'est rapide »).",
  ...
  },
  {
    ...
    sub: "pourquoi ce son, cet instrument, ce rythme",
    levels: {
  ...
  },
  {
    ...
    sub: "l'histoire, l'ambiance que la musique crée",
    levels: {
      4: "Explique clairement ce que la musique représente et fait le lien avec un son ou rythme choisi.",
      3: "Exprime une intention simple (ex. « c'est pour faire peur »).",
      2: "Exprime vaguement ce que la musique représente.",
  ...
  },
  {
    ...
    sub: "réaction spontanée à sa création",
    levels: {
