...
const CRITERIA = [
  { key: 'exploration',    label: 'Exploration sonore' },
  { key: 'intention',      label: 'Intention créatrice' },
  { key: 'organisation',   label: 'Organisation' },
  { key: 'elements',       label: 'Éléments musicaux' },
  { key: 'originalite',    label: 'Originalité' },
  { key: 'revision',       label: 'Révision critique' },
  { key: 'interpretation', label: 'Présentation' },
] as const
...
export default function MusiqueCreerGrid({
  ...
  return (
    <div>
      ...
      <div className="hidden print:block mb-4">
        <h2 className="text-lg font-bold">Musique — Créer — 3e cycle</h2>
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien constant pour s'engager dans la création musicale.",
  2: "L'élève s'engage dans la création avec l'accompagnement de l'enseignant.",
  3: "L'élève crée de façon autonome en mobilisant les éléments appris.",
  4: "L'élève dépasse les attentes et fait preuve d'une créativité personnelle remarquable.",
}

const CRITERIA_FULL = [
  { key: 'exploration',    label: 'Exploration sonore',   description: 'Explore des matériaux sonores variés et les utilise de façon réfléchie.' },
  { key: 'intention',      label: 'Intention créatrice',  description: 'Formule et maintient une intention artistique claire tout au long du processus.' },
  { key: 'organisation',   label: 'Organisation',         description: 'Construit une forme musicale reconnaissable et bien proportionnée.' },
  { key: 'elements',       label: 'Éléments musicaux',    description: 'Intègre plusieurs éléments musicaux avec maîtrise (rythme, mélodie, harmonie, timbre, nuances).' },
  { key: 'originalite',    label: 'Originalité',          description: 'Affirme une voix artistique personnelle dans ses choix créateurs.' },
  { key: 'revision',       label: 'Révision critique',    description: 'Évalue sa propre création et l\'affine de façon autonome suite à une écoute critique.' },
  { key: 'interpretation', label: 'Présentation',         description: 'Présente sa création avec engagement et explique ses intentions artistiques.' },
]
