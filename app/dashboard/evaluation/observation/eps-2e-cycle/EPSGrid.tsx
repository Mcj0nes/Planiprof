...
const CRITERIA = [
  ...
  { key: 'sante',       label: 'Santé et effort' },
] as const
...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève a besoin d'un soutien régulier pour réaliser les actions motrices et interagir avec ses coéquipiers.",
  2: "L'élève s'engage avec aide ; commence à adapter ses actions et à collaborer dans des jeux simples.",
  3: "L'élève s'engage de façon autonome, adapte ses actions au contexte et respecte les règles avec fair-play.",
  4: "L'élève dépasse les attentes : actions motrices précises, stratégies efficaces, fair-play et leadership exemplaires.",
}

const CRITERIA_FULL = [
  { key: 'habiletes',   label: 'Habiletés motrices',   description: "Maîtrise les habiletés motrices dans des situations variées. Les gestes sont de plus en plus précis et contrôlés." },
  { key: 'adaptation',  label: 'Adaptation',            description: "Adapte ses actions à l'environnement, aux partenaires et aux adversaires. Ajuste ses stratégies selon le contexte de jeu." },
  { key: 'cooperation', label: 'Coopération',           description: "Communique et coopère efficacement avec ses coéquipiers. Soutient les autres et assume des rôles variés dans l'équipe." },
  { key: 'regles',      label: 'Règles et fair-play',   description: "Respecte les règles du jeu et fait preuve de fair-play. Accepte les décisions et gère ses émotions en situation de compétition." },
  { key: 'securite',    label: 'Sécurité',              description: "Identifie les risques et adopte des comportements sécuritaires de façon de plus en plus autonome. Veille à la sécurité des autres." },
  { key: 'sante',       label: 'Santé et effort',       description: "Reconnaît les effets de l'effort sur son corps. Adopte des comportements favorables à sa santé et persévère dans l'activité." },
]
