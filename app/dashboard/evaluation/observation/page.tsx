...
const OBSERVATION_TOOLS: Record<string, ObservationTool[]> = {
  ...
  musique: [
    ...
    {
      label:          'Créer',
      href:           '/dashboard/evaluation/observation/musique-creer-1er-cycle',
      cycle:          '1er cycle du primaire (1re et 2e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [1, 2],
    ...
    {
      label:          'Apprécier',
      href:           '/dashboard/evaluation/observation/musique-apprecier-1er-cycle',
      cycle:          '1er cycle du primaire (1re et 2e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [1, 2],
    ...
    {
      label:          'Créer',
      href:           '/dashboard/evaluation/observation/musique-creer-2e-cycle',
      cycle:          '2e cycle du primaire (3e et 4e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [3, 4],
    ...
    {
      label:          'Apprécier',
      href:           '/dashboard/evaluation/observation/musique-apprecier-2e-cycle',
      cycle:          '2e cycle du primaire (3e et 4e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [3, 4],
    ...
    {
      label:          'Créer',
      href:           '/dashboard/evaluation/observation/musique-creer-3e-cycle',
      cycle:          '3e cycle du primaire (5e et 6e année)',
      description:    'Grille d\'observation interactive — 7 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [5, 6],
    ...
    {
      label:          'Apprécier',
      href:           '/dashboard/evaluation/observation/musique-apprecier-3e-cycle',
      cycle:          '3e cycle du primaire (5e et 6e année)',
      description:    'Grille d\'observation interactive — 7 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [5, 6],
  ...
  francais: [
    ...
    {
      label:          'Grille : Écriture',
      href:           '/dashboard/evaluation/observation/ecriture-1er-cycle',
      cycle:          '1er cycle du primaire (1re et 2e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [1, 2],
    ...
    {
      label:          'Grille : Écriture',
      href:           '/dashboard/evaluation/observation/ecriture-2e-cycle',
      cycle:          '2e cycle du primaire (3e et 4e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [3, 4],
    ...
    {
      label:          'Grille : Écriture',
      href:           '/dashboard/evaluation/observation/ecriture-3e-cycle',
      cycle:          '3e cycle du primaire (5e et 6e année)',
      description:    'Grille d\'observation interactive — 6 critères, niveaux 1 à 4',
      educationLevel: 'primaire',
      grades:         [5, 6],
