...
const LEVEL_DESCRIPTIONS: Record<number, string> = {
  1: "L'élève participe peu; réflexion éthique absente ou très superficielle; difficultés à s'engager dans le dialogue.",
  2: "L'élève participe avec soutien; commence à identifier des valeurs et à formuler des points de vue simples.",
  3: "L'élève s'engage de façon autonome dans la réflexion et le dialogue; prend en compte les perspectives des autres.",
  4: "L'élève dépasse les attentes : réflexion nuancée, argumentation solide, écoute exemplaire et enrichissement du groupe.",
}

const CRITERIA_FULL = [
  { key: 'engagement',     label: 'Engagement',          description: "S'engage activement dans les questions éthiques et culturelles; démontre de la curiosité et de l'intérêt." },
  { key: 'reflexion',      label: 'Réflexion éthique',   description: "Réfléchit sur des situations éthiques; identifie des valeurs, des normes et des conséquences possibles." },
  { key: 'perspective',    label: 'Perspectives',         description: "Compare des points de vue différents et prend en compte la diversité des perspectives dans sa réflexion." },
  { key: 'ecoute',         label: 'Écoute active',        description: "Écoute attentivement ses pairs; reformule ou réagit aux idées des autres de façon pertinente." },
  { key: 'dialogue',       label: 'Dialogue',             description: "Participe au dialogue en formulant des questions pertinentes et en contribuant à la progression des échanges." },
  { key: 'argumentation',  label: 'Argumentation',        description: "Appuie ses opinions sur des raisons; distingue faits et opinions; nuance ses propos selon le contexte." },
]
