          ...
          <div className="mt-8 space-y-8">
            ...
            <section>
              ...
              {myGrids.length === 0 ? (
                ...
                <div className="space-y-3">
                  {myGrids.map((g: any) => (
                    <div key={g.id} className="bg-white border border-blue-200 rounded-2xl p-5 flex items-center justify-between shadow-sm">
                      <div>
                        <p className="font-semibold text-gray-800">{g.title}</p>
                        <div className="flex items-center gap-3 mt-1">
                          {g.competency && <span className="text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full">{g.competency}</span>}
                      ...
                      <Link
                        href={`/dashboard/evaluation/grilles/${g.id}${queryString}`}
                        className="text-sm px-4 py-2 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition shrink-0"
                      >
                        Voir / Modifier
                      </Link>
                    </div>
