    ...
    <main className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        <p className="text-gray-500 mb-10">
          Structurez vos contenus et évaluations selon les trois étapes du bulletin scolaire.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          >
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">Organisez chaque étape du bulletin avec ses contenus et évaluations.</p>
            </div>
